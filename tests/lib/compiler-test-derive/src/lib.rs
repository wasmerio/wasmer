...
fn compiler_test_impl(attrs: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let cranelift_exp_artifact_engine_test = {
        let mut new_sig = my_fn.sig.clone();
        let attrs = my_fn
            .attrs
            .clone()
            .iter()
            .fold(quote! {}, |acc, new| quote! {#acc #new});
        new_sig.ident = ::quote::format_ident!("cranelift_exp_artifact");
        new_sig.inputs = ::syn::punctuated::Punctuated::new();
        let f = quote! {
            #[test_log::test]
            #attrs
    ...
    let cranelift_exp_artifact_compiler_test = quote! {
        #[cfg(all(
            feature = "cranelift",
            feature = "experimental-artifact",
            target_os = "linux",
        ...
        mod cranelift_exp_artifact {
            ...
            #cranelift_exp_artifact_engine_test
        }
    };
    ...
    let x = quote! {
        ...
        mod #fn_name {
            ...
            #cranelift_exp_artifact_compiler_test
        }
    };
