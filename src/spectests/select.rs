...
fn c1_l31_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_i32", &[Value::I32(1 as i32), Value::I32(2 as i32), Value::I32(1 as i32)]).expect("Missing result in c1_l31_action_invoke");
...
fn c2_l32_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_i64", &[Value::I64(2 as i64), Value::I64(1 as i64), Value::I32(1 as i32)]).expect("Missing result in c2_l32_action_invoke");
...
fn c3_l33_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32((1.0f32).to_bits()), Value::F32((2.0f32).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c3_l33_action_invoke");
...
fn c4_l34_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64((1.0f64).to_bits()), Value::F64((2.0f64).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c4_l34_action_invoke");
...
fn c5_l36_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_i32", &[Value::I32(1 as i32), Value::I32(2 as i32), Value::I32(0 as i32)]).expect("Missing result in c5_l36_action_invoke");
...
fn c6_l37_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_i32", &[Value::I32(2 as i32), Value::I32(1 as i32), Value::I32(0 as i32)]).expect("Missing result in c6_l37_action_invoke");
    assert_eq!(result, Some(Value::I32(1 as i32)));
}
...
fn c7_l38_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_i64", &[Value::I64(2 as i64), Value::I64(1 as i64), Value::I32(-1 as i32)]).expect("Missing result in c7_l38_action_invoke");
    assert_eq!(result, Some(Value::I64(2 as i64)));
}
...
fn c8_l39_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_i64", &[Value::I64(2 as i64), Value::I64(1 as i64), Value::I32(-252645136 as i32)]).expect("Missing result in c8_l39_action_invoke");
    assert_eq!(result, Some(Value::I64(2 as i64)));
}
...
fn c9_l41_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32(f32::from_bits(2143289344) as u32), Value::F32((1.0f32).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c9_l41_action_invoke");
...
fn c10_l42_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32(f32::from_bits(2139226884) as u32), Value::F32((1.0f32).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c10_l42_action_invoke");
...
fn c11_l43_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32(f32::from_bits(2143289344) as u32), Value::F32((1.0f32).to_bits()), Value::I32(0 as i32)]).expect("Missing result in c11_l43_action_invoke");
    assert_eq!(result, Some(Value::F32((1.0f32).to_bits())));
}
...
fn c12_l44_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32(f32::from_bits(2139226884) as u32), Value::F32((1.0f32).to_bits()), Value::I32(0 as i32)]).expect("Missing result in c12_l44_action_invoke");
    assert_eq!(result, Some(Value::F32((1.0f32).to_bits())));
}
...
fn c13_l45_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32((2.0f32).to_bits()), Value::F32(f32::from_bits(2143289344) as u32), Value::I32(1 as i32)]).expect("Missing result in c13_l45_action_invoke");
...
fn c14_l46_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32((2.0f32).to_bits()), Value::F32(f32::from_bits(2139226884) as u32), Value::I32(1 as i32)]).expect("Missing result in c14_l46_action_invoke");
    assert_eq!(result, Some(Value::F32((2.0f32).to_bits())));
}
...
fn c15_l47_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32((2.0f32).to_bits()), Value::F32(f32::from_bits(2143289344) as u32), Value::I32(0 as i32)]).expect("Missing result in c15_l47_action_invoke");
    let expected = f32::from_bits(2143289344);
                                if let Value::F32(result) = result.unwrap() {
                                assert!((result as f32).is_nan());
            assert_eq!((result as f32).is_sign_positive(), (expected as f32).is_sign_positive());
...
fn c16_l48_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f32", &[Value::F32((2.0f32).to_bits()), Value::F32(f32::from_bits(2139226884) as u32), Value::I32(0 as i32)]).expect("Missing result in c16_l48_action_invoke");
    let expected = f32::from_bits(2139226884);
                                if let Value::F32(result) = result.unwrap() {
                                assert!((result as f32).is_nan());
            assert_eq!((result as f32).is_sign_positive(), (expected as f32).is_sign_positive());
...
fn c17_l50_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64(f64::from_bits(9221120237041090560) as u64), Value::F64((1.0f64).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c17_l50_action_invoke");
...
fn c18_l51_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64(f64::from_bits(9218868437227537156) as u64), Value::F64((1.0f64).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c18_l51_action_invoke");
...
fn c19_l52_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64(f64::from_bits(9221120237041090560) as u64), Value::F64((1.0f64).to_bits()), Value::I32(0 as i32)]).expect("Missing result in c19_l52_action_invoke");
    assert_eq!(result, Some(Value::F64((1.0f64).to_bits())));
}
...
fn c20_l53_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64(f64::from_bits(9218868437227537156) as u64), Value::F64((1.0f64).to_bits()), Value::I32(0 as i32)]).expect("Missing result in c20_l53_action_invoke");
    assert_eq!(result, Some(Value::F64((1.0f64).to_bits())));
}
...
fn c21_l54_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64((2.0f64).to_bits()), Value::F64(f64::from_bits(9221120237041090560) as u64), Value::I32(1 as i32)]).expect("Missing result in c21_l54_action_invoke");
...
fn c22_l55_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64((2.0f64).to_bits()), Value::F64(f64::from_bits(9218868437227537156) as u64), Value::I32(1 as i32)]).expect("Missing result in c22_l55_action_invoke");
    assert_eq!(result, Some(Value::F64((2.0f64).to_bits())));
}
...
fn c23_l56_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64((2.0f64).to_bits()), Value::F64(f64::from_bits(9221120237041090560) as u64), Value::I32(0 as i32)]).expect("Missing result in c23_l56_action_invoke");
    let expected = f64::from_bits(9221120237041090560);
                                if let Value::F64(result) = result.unwrap() {
                                assert!((result as f64).is_nan());
            assert_eq!((result as f64).is_sign_positive(), (expected as f64).is_sign_positive());
...
fn c24_l57_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_f64", &[Value::F64((2.0f64).to_bits()), Value::F64(f64::from_bits(9218868437227537156) as u64), Value::I32(0 as i32)]).expect("Missing result in c24_l57_action_invoke");
    let expected = f64::from_bits(9218868437227537156);
                                if let Value::F64(result) = result.unwrap() {
                                assert!((result as f64).is_nan());
            assert_eq!((result as f64).is_sign_positive(), (expected as f64).is_sign_positive());
...
fn c25_l59_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_trap_l", &[Value::I32(1 as i32)]).expect("Missing result in c25_l59_action_invoke");
...
fn c26_l60_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_trap_l", &[Value::I32(0 as i32)]).expect("Missing result in c26_l60_action_invoke");
...
fn c27_l61_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_trap_r", &[Value::I32(1 as i32)]).expect("Missing result in c27_l61_action_invoke");
...
fn c28_l62_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select_trap_r", &[Value::I32(0 as i32)]).expect("Missing result in c28_l62_action_invoke");
