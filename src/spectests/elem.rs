...
fn c8_l81_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("c8_l81_action_invoke", &[]).expect("Missing result in c8_l81_action_invoke");
...
fn c9_l82_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("c9_l82_action_invoke", &[]).expect("Missing result in c9_l82_action_invoke");
...
fn c39_l316_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("c39_l316_action_invoke", &[]).expect("Missing result in c39_l316_action_invoke");
    assert_eq!(result, Some(Value::I32(66 as i32)));
}
...
fn c41_l329_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("c41_l329_action_invoke", &[]).expect("Missing result in c41_l329_action_invoke");
    assert_eq!(result, Some(Value::I32(66 as i32)));
}
...
fn c44_l353_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("c44_l353_action_invoke", &[]).expect("Missing result in c44_l353_action_invoke");
...
fn c45_l354_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("c45_l354_action_invoke", &[]).expect("Missing result in c45_l354_action_invoke");
    assert_eq!(result, Some(Value::I32(65 as i32)));
}
...
fn c46_l355_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("c46_l355_action_invoke", &[]).expect("Missing result in c46_l355_action_invoke");
    assert_eq!(result, Some(Value::I32(66 as i32)));
}
