...
fn c1_l171_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-use-1", &[]).expect("Missing result in c1_l171_action_invoke");
...
fn c2_l172_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-use-2", &[]).expect("Missing result in c2_l172_action_invoke");
...
fn c3_l173_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-use-3", &[Value::I32(1 as i32)]).expect("Missing result in c3_l173_action_invoke");
    assert_eq!(result, None);
}
...
fn c4_l175_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-use-4", &[Value::I32(1 as i32), Value::F64((1.0f64).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c4_l175_action_invoke");
    assert_eq!(result, Some(Value::I32(0 as i32)));
}
...
fn c5_l178_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-use-5", &[]).expect("Missing result in c5_l178_action_invoke");
    assert_eq!(result, Some(Value::I32(0 as i32)));
}
...
fn c6_l179_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-use-6", &[Value::I32(1 as i32)]).expect("Missing result in c6_l179_action_invoke");
    assert_eq!(result, None);
}
...
fn c7_l181_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-use-7", &[Value::I32(1 as i32), Value::F64((1.0f64).to_bits()), Value::I32(1 as i32)]).expect("Missing result in c7_l181_action_invoke");
    assert_eq!(result, Some(Value::I32(0 as i32)));
}
...
fn c8_l185_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-first-i32", &[]).expect("Missing result in c8_l185_action_invoke");
    assert_eq!(result, Some(Value::I32(0 as i32)));
}
...
fn c9_l186_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-first-i64", &[]).expect("Missing result in c9_l186_action_invoke");
...
fn c10_l187_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-first-f32", &[]).expect("Missing result in c10_l187_action_invoke");
...
fn c11_l188_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-first-f64", &[]).expect("Missing result in c11_l188_action_invoke");
...
fn c12_l189_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-second-i32", &[]).expect("Missing result in c12_l189_action_invoke");
    assert_eq!(result, Some(Value::I32(0 as i32)));
}
...
fn c13_l190_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-second-i64", &[]).expect("Missing result in c13_l190_action_invoke");
    assert_eq!(result, Some(Value::I64(0 as i64)));
}
...
fn c14_l191_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-second-f32", &[]).expect("Missing result in c14_l191_action_invoke");
    assert_eq!(result, Some(Value::F32((0.0f32).to_bits())));
}
...
fn c15_l192_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-second-f64", &[]).expect("Missing result in c15_l192_action_invoke");
    assert_eq!(result, Some(Value::F64((0.0f64).to_bits())));
}
...
fn c16_l193_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("local-mixed", &[]).expect("Missing result in c16_l193_action_invoke");
    assert_eq!(result, Some(Value::F64((0.0f64).to_bits())));
}
...
fn c17_l196_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-first-i32", &[Value::I32(2 as i32), Value::I32(3 as i32)]).expect("Missing result in c17_l196_action_invoke");
...
fn c18_l199_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-first-i64", &[Value::I64(2 as i64), Value::I64(3 as i64)]).expect("Missing result in c18_l199_action_invoke");
...
fn c19_l202_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-first-f32", &[Value::F32((2.0f32).to_bits()), Value::F32((3.0f32).to_bits())]).expect("Missing result in c19_l202_action_invoke");
...
fn c20_l205_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-first-f64", &[Value::F64((2.0f64).to_bits()), Value::F64((3.0f64).to_bits())]).expect("Missing result in c20_l205_action_invoke");
...
fn c21_l208_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-second-i32", &[Value::I32(2 as i32), Value::I32(3 as i32)]).expect("Missing result in c21_l208_action_invoke");
...
fn c22_l211_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-second-i64", &[Value::I64(2 as i64), Value::I64(3 as i64)]).expect("Missing result in c22_l211_action_invoke");
...
fn c23_l214_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-second-f32", &[Value::F32((2.0f32).to_bits()), Value::F32((3.0f32).to_bits())]).expect("Missing result in c23_l214_action_invoke");
...
fn c24_l217_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-second-f64", &[Value::F64((2.0f64).to_bits()), Value::F64((3.0f64).to_bits())]).expect("Missing result in c24_l217_action_invoke");
...
fn c25_l221_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("param-mixed", &[Value::F32((1.0f32).to_bits()), Value::I32(2 as i32), Value::I64(3 as i64), Value::I32(4 as i32), Value::F64((5.5f64).to_bits()), Value::I32(6 as i32)]).expect("Missing result in c25_l221_action_invoke");
...
fn c26_l228_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("empty", &[]).expect("Missing result in c26_l228_action_invoke");
    assert_eq!(result, None);
}
...
fn c27_l229_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("value-void", &[]).expect("Missing result in c27_l229_action_invoke");
    assert_eq!(result, None);
}
...
fn c28_l230_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("value-i32", &[]).expect("Missing result in c28_l230_action_invoke");
...
fn c29_l231_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("value-i64", &[]).expect("Missing result in c29_l231_action_invoke");
...
fn c30_l232_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("value-f32", &[]).expect("Missing result in c30_l232_action_invoke");
...
fn c31_l233_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("value-f64", &[]).expect("Missing result in c31_l233_action_invoke");
...
fn c32_l234_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("value-block-void", &[]).expect("Missing result in c32_l234_action_invoke");
    assert_eq!(result, None);
}
...
fn c33_l235_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("value-block-i32", &[]).expect("Missing result in c33_l235_action_invoke");
    assert_eq!(result, Some(Value::I32(77 as i32)));
}
...
fn c34_l237_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("return-empty", &[]).expect("Missing result in c34_l237_action_invoke");
    assert_eq!(result, None);
}
...
fn c35_l238_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("return-i32", &[]).expect("Missing result in c35_l238_action_invoke");
...
fn c36_l239_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("return-i64", &[]).expect("Missing result in c36_l239_action_invoke");
...
fn c37_l240_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("return-f32", &[]).expect("Missing result in c37_l240_action_invoke");
...
fn c38_l241_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("return-f64", &[]).expect("Missing result in c38_l241_action_invoke");
...
fn c39_l242_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("return-block-i32", &[]).expect("Missing result in c39_l242_action_invoke");
    assert_eq!(result, Some(Value::I32(77 as i32)));
}
...
fn c40_l244_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-empty", &[]).expect("Missing result in c40_l244_action_invoke");
    assert_eq!(result, None);
}
...
fn c41_l245_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-i32", &[]).expect("Missing result in c41_l245_action_invoke");
...
fn c42_l246_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-i64", &[]).expect("Missing result in c42_l246_action_invoke");
...
fn c43_l247_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-f32", &[]).expect("Missing result in c43_l247_action_invoke");
...
fn c44_l248_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-f64", &[]).expect("Missing result in c44_l248_action_invoke");
...
fn c45_l249_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-block-i32", &[]).expect("Missing result in c45_l249_action_invoke");
    assert_eq!(result, Some(Value::I32(77 as i32)));
}
...
fn c46_l251_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_if-empty", &[Value::I32(0 as i32)]).expect("Missing result in c46_l251_action_invoke");
    assert_eq!(result, None);
}
...
fn c47_l252_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_if-empty", &[Value::I32(2 as i32)]).expect("Missing result in c47_l252_action_invoke");
    assert_eq!(result, None);
}
...
fn c48_l253_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_if-num", &[Value::I32(0 as i32)]).expect("Missing result in c48_l253_action_invoke");
...
fn c49_l254_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_if-num", &[Value::I32(1 as i32)]).expect("Missing result in c49_l254_action_invoke");
...
fn c50_l256_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-empty", &[Value::I32(0 as i32)]).expect("Missing result in c50_l256_action_invoke");
    assert_eq!(result, None);
}
...
fn c51_l257_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-empty", &[Value::I32(1 as i32)]).expect("Missing result in c51_l257_action_invoke");
    assert_eq!(result, None);
}
...
fn c52_l258_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-empty", &[Value::I32(5 as i32)]).expect("Missing result in c52_l258_action_invoke");
    assert_eq!(result, None);
}
...
fn c53_l259_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-empty", &[Value::I32(-1 as i32)]).expect("Missing result in c53_l259_action_invoke");
    assert_eq!(result, None);
}
...
fn c54_l260_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-num", &[Value::I32(0 as i32)]).expect("Missing result in c54_l260_action_invoke");
    assert_eq!(result, Some(Value::I32(50 as i32)));
}
...
fn c55_l261_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-num", &[Value::I32(1 as i32)]).expect("Missing result in c55_l261_action_invoke");
    assert_eq!(result, Some(Value::I32(50 as i32)));
}
...
fn c56_l262_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-num", &[Value::I32(10 as i32)]).expect("Missing result in c56_l262_action_invoke");
    assert_eq!(result, Some(Value::I32(50 as i32)));
}
...
fn c57_l263_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-num", &[Value::I32(-100 as i32)]).expect("Missing result in c57_l263_action_invoke");
    assert_eq!(result, Some(Value::I32(50 as i32)));
}
...
fn c58_l264_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-empty", &[Value::I32(0 as i32)]).expect("Missing result in c58_l264_action_invoke");
    assert_eq!(result, None);
}
...
fn c59_l265_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-empty", &[Value::I32(1 as i32)]).expect("Missing result in c59_l265_action_invoke");
    assert_eq!(result, None);
}
...
fn c60_l266_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-empty", &[Value::I32(3 as i32)]).expect("Missing result in c60_l266_action_invoke");
    assert_eq!(result, None);
}
...
fn c61_l267_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-empty", &[Value::I32(-2 as i32)]).expect("Missing result in c61_l267_action_invoke");
    assert_eq!(result, None);
}
...
fn c62_l269_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-num", &[Value::I32(0 as i32)]).expect("Missing result in c62_l269_action_invoke");
...
fn c63_l272_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-num", &[Value::I32(1 as i32)]).expect("Missing result in c63_l272_action_invoke");
    assert_eq!(result, Some(Value::I32(50 as i32)));
}
...
fn c64_l275_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-num", &[Value::I32(2 as i32)]).expect("Missing result in c64_l275_action_invoke");
    assert_eq!(result, Some(Value::I32(52 as i32)));
}
...
fn c65_l278_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("break-br_table-nested-num", &[Value::I32(-3 as i32)]).expect("Missing result in c65_l278_action_invoke");
    assert_eq!(result, Some(Value::I32(52 as i32)));
}
...
fn c66_l281_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("init-local-i32", &[]).expect("Missing result in c66_l281_action_invoke");
    assert_eq!(result, Some(Value::I32(0 as i32)));
}
...
fn c67_l282_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("init-local-i64", &[]).expect("Missing result in c67_l282_action_invoke");
    assert_eq!(result, Some(Value::I64(0 as i64)));
}
...
fn c68_l283_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("init-local-f32", &[]).expect("Missing result in c68_l283_action_invoke");
    assert_eq!(result, Some(Value::F32((0.0f32).to_bits())));
}
...
fn c69_l284_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("init-local-f64", &[]).expect("Missing result in c69_l284_action_invoke");
    assert_eq!(result, Some(Value::F64((0.0f64).to_bits())));
}
...
fn c73_l378_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("signature-explicit-reused", &[]).expect("Missing result in c73_l378_action_invoke");
    assert_eq!(result, None);
}
...
fn c74_l379_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("signature-implicit-reused", &[]).expect("Missing result in c74_l379_action_invoke");
    assert_eq!(result, None);
}
...
fn c75_l380_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("signature-explicit-duplicate", &[]).expect("Missing result in c75_l380_action_invoke");
    assert_eq!(result, None);
}
...
fn c76_l381_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("signature-implicit-duplicate", &[]).expect("Missing result in c76_l381_action_invoke");
    assert_eq!(result, None);
}
