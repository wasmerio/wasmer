...
fn c1_l212_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-unreachable", &[]).expect("Missing result in c1_l212_action_invoke");
...
fn c2_l213_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-br", &[]).expect("Missing result in c2_l213_action_invoke");
...
fn c3_l214_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-br-value", &[]).expect("Missing result in c3_l214_action_invoke");
...
fn c4_l215_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-br_if", &[]).expect("Missing result in c4_l215_action_invoke");
    assert_eq!(result, None);
}
...
fn c5_l216_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-br_if-value", &[]).expect("Missing result in c5_l216_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c6_l217_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-br_table", &[]).expect("Missing result in c6_l217_action_invoke");
    assert_eq!(result, None);
}
...
fn c7_l218_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-br_table-value", &[]).expect("Missing result in c7_l218_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c8_l219_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("func-unwind-by-return", &[]).expect("Missing result in c8_l219_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c9_l221_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-unreachable", &[]).expect("Missing result in c9_l221_action_invoke");
...
fn c10_l222_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-br", &[]).expect("Missing result in c10_l222_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c11_l223_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-br-value", &[]).expect("Missing result in c11_l223_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c12_l224_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-br_if", &[]).expect("Missing result in c12_l224_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c13_l225_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-br_if-value", &[]).expect("Missing result in c13_l225_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c14_l226_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-br_table", &[]).expect("Missing result in c14_l226_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c15_l227_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-br_table-value", &[]).expect("Missing result in c15_l227_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c16_l228_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-unwind-by-return", &[]).expect("Missing result in c16_l228_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c17_l230_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-unreachable", &[]).expect("Missing result in c17_l230_action_invoke");
...
fn c18_l231_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-br", &[]).expect("Missing result in c18_l231_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c19_l232_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-br-value", &[]).expect("Missing result in c19_l232_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c20_l233_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-br_if", &[]).expect("Missing result in c20_l233_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c21_l234_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-br_if-value", &[]).expect("Missing result in c21_l234_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c22_l235_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-br_table", &[]).expect("Missing result in c22_l235_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c23_l236_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-br_table-value", &[]).expect("Missing result in c23_l236_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c24_l237_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-nested-unwind-by-return", &[]).expect("Missing result in c24_l237_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c25_l239_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("unary-after-unreachable", &[]).expect("Missing result in c25_l239_action_invoke");
...
fn c26_l240_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("unary-after-br", &[]).expect("Missing result in c26_l240_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c27_l241_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("unary-after-br_if", &[]).expect("Missing result in c27_l241_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c28_l242_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("unary-after-br_table", &[]).expect("Missing result in c28_l242_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c29_l243_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("unary-after-return", &[]).expect("Missing result in c29_l243_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c30_l245_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("binary-after-unreachable", &[]).expect("Missing result in c30_l245_action_invoke");
...
fn c31_l246_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("binary-after-br", &[]).expect("Missing result in c31_l246_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c32_l247_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("binary-after-br_if", &[]).expect("Missing result in c32_l247_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c33_l248_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("binary-after-br_table", &[]).expect("Missing result in c33_l248_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c34_l249_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("binary-after-return", &[]).expect("Missing result in c34_l249_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c35_l251_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select-after-unreachable", &[]).expect("Missing result in c35_l251_action_invoke");
...
fn c36_l252_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select-after-br", &[]).expect("Missing result in c36_l252_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c37_l253_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select-after-br_if", &[]).expect("Missing result in c37_l253_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c38_l254_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select-after-br_table", &[]).expect("Missing result in c38_l254_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c39_l255_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("select-after-return", &[]).expect("Missing result in c39_l255_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c40_l257_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-value-after-unreachable", &[]).expect("Missing result in c40_l257_action_invoke");
...
fn c41_l258_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-value-after-br", &[]).expect("Missing result in c41_l258_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c42_l259_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-value-after-br_if", &[]).expect("Missing result in c42_l259_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c43_l260_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-value-after-br_table", &[]).expect("Missing result in c43_l260_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c44_l261_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("block-value-after-return", &[]).expect("Missing result in c44_l261_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c45_l263_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("loop-value-after-unreachable", &[]).expect("Missing result in c45_l263_action_invoke");
...
fn c46_l264_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("loop-value-after-br", &[]).expect("Missing result in c46_l264_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c47_l265_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("loop-value-after-br_if", &[]).expect("Missing result in c47_l265_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c48_l266_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("loop-value-after-br_table", &[]).expect("Missing result in c48_l266_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
...
fn c49_l267_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("loop-value-after-return", &[]).expect("Missing result in c49_l267_action_invoke");
    assert_eq!(result, Some(Value::I32(9 as i32)));
}
