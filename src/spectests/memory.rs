...
// Line 11
fn c7_l11_action_invoke(result_object: &mut ResultObject) {
    println!("Executing function {}", "c7_l11_action_invoke");
    let result = result_object.instance.call("c7_l11_action_invoke", &[]).expect("Missing result in c7_l11_action_invoke");
...
fn test_module_5() {
    ...
    c7_l11_action_invoke(&mut result_object);
}
...
// Line 13
fn c9_l13_action_invoke(result_object: &mut ResultObject) {
    println!("Executing function {}", "c9_l13_action_invoke");
    let result = result_object.instance.call("c9_l13_action_invoke", &[]).expect("Missing result in c9_l13_action_invoke");
    assert_eq!(result, Some(Value::I32(0 as i32)));
}
...
fn test_module_6() {
    ...
    c9_l13_action_invoke(&mut result_object);
}
...
// Line 15
fn c11_l15_action_invoke(result_object: &mut ResultObject) {
    println!("Executing function {}", "c11_l15_action_invoke");
    let result = result_object.instance.call("c11_l15_action_invoke", &[]).expect("Missing result in c11_l15_action_invoke");
...
fn test_module_7() {
    ...
    c11_l15_action_invoke(&mut result_object);
}
