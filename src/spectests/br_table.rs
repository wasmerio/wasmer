...
fn c11_l1259_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("empty", &[Value::I32(11 as i32)])
...
fn c13_l1261_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("empty", &[Value::I32(-100 as i32)])
...
fn c15_l1264_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("empty-value", &[Value::I32(0 as i32)])
...
fn c16_l1265_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("empty-value", &[Value::I32(1 as i32)])
...
fn c17_l1266_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("empty-value", &[Value::I32(11 as i32)])
...
fn c19_l1268_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("empty-value", &[Value::I32(-100 as i32)])
...
fn c21_l1271_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton", &[Value::I32(0 as i32)])
...
fn c22_l1272_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton", &[Value::I32(1 as i32)])
...
fn c23_l1273_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton", &[Value::I32(11 as i32)])
...
fn c25_l1275_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton", &[Value::I32(-100 as i32)])
...
fn c27_l1278_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton-value", &[Value::I32(0 as i32)])
...
fn c28_l1279_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton-value", &[Value::I32(1 as i32)])
...
fn c29_l1280_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton-value", &[Value::I32(11 as i32)])
...
fn c31_l1282_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("singleton-value", &[Value::I32(-100 as i32)])
...
fn c33_l1285_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(0 as i32)])
...
fn c34_l1286_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(1 as i32)])
...
fn c35_l1287_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(2 as i32)])
...
fn c36_l1288_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(3 as i32)])
...
fn c37_l1289_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(4 as i32)])
...
fn c38_l1290_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(5 as i32)])
...
fn c39_l1291_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(6 as i32)])
...
fn c40_l1292_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple", &[Value::I32(10 as i32)])
...
fn c43_l1296_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(0 as i32)])
...
fn c44_l1297_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(1 as i32)])
...
fn c45_l1298_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(2 as i32)])
...
fn c46_l1299_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(3 as i32)])
...
fn c47_l1300_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(4 as i32)])
...
fn c48_l1301_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(5 as i32)])
...
fn c49_l1302_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(6 as i32)])
...
fn c50_l1303_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("multiple-value", &[Value::I32(10 as i32)])
...
fn c55_l1309_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("large", &[Value::I32(100 as i32)])
...
fn c56_l1310_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("large", &[Value::I32(101 as i32)])
...
fn c57_l1311_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("large", &[Value::I32(10000 as i32)])
...
fn c58_l1312_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("large", &[Value::I32(10001 as i32)])
...
fn c59_l1313_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("large", &[Value::I32(1000000 as i32)])
...
fn c60_l1314_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("large", &[Value::I32(1000001 as i32)])
...
fn c77_l1338_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("as-if-then", &[Value::I32(1 as i32), Value::I32(6 as i32)])
...
fn c78_l1339_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("as-if-then", &[Value::I32(0 as i32), Value::I32(6 as i32)])
...
fn c79_l1340_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("as-if-else", &[Value::I32(0 as i32), Value::I32(6 as i32)])
...
fn c80_l1341_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("as-if-else", &[Value::I32(1 as i32), Value::I32(6 as i32)])
...
fn c110_l1384_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-block-value", &[Value::I32(0 as i32)])
...
fn c111_l1385_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-block-value", &[Value::I32(1 as i32)])
...
fn c112_l1386_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-block-value", &[Value::I32(2 as i32)])
...
fn c113_l1387_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-block-value", &[Value::I32(10 as i32)])
...
fn c115_l1389_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-block-value", &[Value::I32(100000 as i32)])
...
fn c116_l1391_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br-value", &[Value::I32(0 as i32)])
...
fn c117_l1392_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br-value", &[Value::I32(1 as i32)])
...
fn c118_l1393_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br-value", &[Value::I32(2 as i32)])
...
fn c119_l1394_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br-value", &[Value::I32(11 as i32)])
...
fn c120_l1395_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br-value", &[Value::I32(-4 as i32)])
...
fn c121_l1396_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br-value", &[Value::I32(10213210 as i32)])
...
fn c122_l1398_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value", &[Value::I32(0 as i32)])
...
fn c123_l1399_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value", &[Value::I32(1 as i32)])
...
fn c124_l1400_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value", &[Value::I32(2 as i32)])
...
fn c125_l1401_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value", &[Value::I32(9 as i32)])
...
fn c127_l1403_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value", &[Value::I32(999999 as i32)])
...
fn c128_l1405_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value-cond", &[Value::I32(0 as i32)])
...
fn c129_l1406_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value-cond", &[Value::I32(1 as i32)])
...
fn c130_l1407_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value-cond", &[Value::I32(2 as i32)])
...
fn c131_l1408_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value-cond", &[Value::I32(3 as i32)])
...
fn c132_l1409_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value-cond", &[Value::I32(-1000000 as i32)])
...
fn c133_l1410_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_if-value-cond", &[Value::I32(9423975 as i32)])
...
fn c134_l1412_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value", &[Value::I32(0 as i32)])
...
fn c135_l1413_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value", &[Value::I32(1 as i32)])
...
fn c136_l1414_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value", &[Value::I32(2 as i32)])
...
fn c137_l1415_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value", &[Value::I32(9 as i32)])
...
fn c139_l1417_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value", &[Value::I32(999999 as i32)])
...
fn c140_l1419_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value-index", &[Value::I32(0 as i32)])
...
fn c141_l1420_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value-index", &[Value::I32(1 as i32)])
...
fn c142_l1421_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value-index", &[Value::I32(2 as i32)])
...
fn c143_l1422_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value-index", &[Value::I32(3 as i32)])
...
fn c145_l1424_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-value-index", &[Value::I32(9423975 as i32)])
...
fn c146_l1426_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("nested-br_table-loop-block", &[Value::I32(1 as i32)])
