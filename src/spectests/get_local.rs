...
fn c1_l64_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-local-i32", &[]).expect("Missing result in c1_l64_action_invoke");
...
fn c2_l65_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-local-i64", &[]).expect("Missing result in c2_l65_action_invoke");
...
fn c3_l66_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-local-f32", &[]).expect("Missing result in c3_l66_action_invoke");
...
fn c4_l67_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-local-f64", &[]).expect("Missing result in c4_l67_action_invoke");
...
fn c5_l69_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-param-i32", &[Value::I32(2 as i32)]).expect("Missing result in c5_l69_action_invoke");
...
fn c6_l70_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-param-i64", &[Value::I64(3 as i64)]).expect("Missing result in c6_l70_action_invoke");
...
fn c7_l71_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-param-f32", &[Value::F32((4.4f32).to_bits())]).expect("Missing result in c7_l71_action_invoke");
...
fn c8_l72_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-param-f64", &[Value::F64((5.5f64).to_bits())]).expect("Missing result in c8_l72_action_invoke");
...
fn c9_l75_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("type-mixed", &[Value::I64(1 as i64), Value::F32((2.2f32).to_bits()), Value::F64((3.3f64).to_bits()), Value::I32(4 as i32), Value::I32(5 as i32)]).expect("Missing result in c9_l75_action_invoke");
...
fn c10_l81_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("read", &[Value::I64(1 as i64), Value::F32((2.0f32).to_bits()), Value::F64((3.3f64).to_bits()), Value::I32(4 as i32), Value::I32(5 as i32)]).expect("Missing result in c10_l81_action_invoke");
...
fn test_module_1() {
    ...
    c1_l64_action_invoke(&mut result_object);
    c2_l65_action_invoke(&mut result_object);
    c3_l66_action_invoke(&mut result_object);
    c4_l67_action_invoke(&mut result_object);
    c5_l69_action_invoke(&mut result_object);
    c6_l70_action_invoke(&mut result_object);
    c7_l71_action_invoke(&mut result_object);
    c8_l72_action_invoke(&mut result_object);
    c9_l75_action_invoke(&mut result_object);
    c10_l81_action_invoke(&mut result_object);
}
