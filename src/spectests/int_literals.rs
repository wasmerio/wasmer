...
fn c1_l37_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.test", &[]).expect("Missing result in c1_l37_action_invoke");
...
fn c2_l38_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.umax", &[]).expect("Missing result in c2_l38_action_invoke");
...
fn c3_l39_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.smax", &[]).expect("Missing result in c3_l39_action_invoke");
...
fn c4_l40_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.neg_smax", &[]).expect("Missing result in c4_l40_action_invoke");
    assert_eq!(result, Some(Value::I32(-2147483647 as i32)));
}
...
fn c5_l41_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.smin", &[]).expect("Missing result in c5_l41_action_invoke");
...
fn c6_l42_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.alt_smin", &[]).expect("Missing result in c6_l42_action_invoke");
    assert_eq!(result, Some(Value::I32(-2147483648 as i32)));
}
...
fn c7_l43_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.inc_smin", &[]).expect("Missing result in c7_l43_action_invoke");
    assert_eq!(result, Some(Value::I32(-2147483647 as i32)));
}
...
fn c8_l44_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.neg_zero", &[]).expect("Missing result in c8_l44_action_invoke");
...
fn c9_l45_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.not_octal", &[]).expect("Missing result in c9_l45_action_invoke");
...
fn c10_l46_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.unsigned_decimal", &[]).expect("Missing result in c10_l46_action_invoke");
    assert_eq!(result, Some(Value::I32(-1 as i32)));
}
...
fn c11_l47_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32.plus_sign", &[]).expect("Missing result in c11_l47_action_invoke");
...
fn c12_l49_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.test", &[]).expect("Missing result in c12_l49_action_invoke");
...
fn c13_l50_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.umax", &[]).expect("Missing result in c13_l50_action_invoke");
...
fn c14_l51_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.smax", &[]).expect("Missing result in c14_l51_action_invoke");
...
fn c15_l52_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.neg_smax", &[]).expect("Missing result in c15_l52_action_invoke");
    assert_eq!(result, Some(Value::I64(-9223372036854775807 as i64)));
}
...
fn c16_l53_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.smin", &[]).expect("Missing result in c16_l53_action_invoke");
...
fn c17_l54_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.alt_smin", &[]).expect("Missing result in c17_l54_action_invoke");
    assert_eq!(result, Some(Value::I64(-9223372036854775808 as i64)));
}
...
fn c18_l55_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.inc_smin", &[]).expect("Missing result in c18_l55_action_invoke");
    assert_eq!(result, Some(Value::I64(-9223372036854775807 as i64)));
}
...
fn c19_l56_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.neg_zero", &[]).expect("Missing result in c19_l56_action_invoke");
...
fn c20_l57_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.not_octal", &[]).expect("Missing result in c20_l57_action_invoke");
...
fn c21_l58_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.unsigned_decimal", &[]).expect("Missing result in c21_l58_action_invoke");
    assert_eq!(result, Some(Value::I64(-1 as i64)));
}
...
fn c22_l59_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64.plus_sign", &[]).expect("Missing result in c22_l59_action_invoke");
...
fn c23_l61_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32-dec-sep1", &[]).expect("Missing result in c23_l61_action_invoke");
...
fn c24_l62_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32-dec-sep2", &[]).expect("Missing result in c24_l62_action_invoke");
...
fn c25_l63_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32-hex-sep1", &[]).expect("Missing result in c25_l63_action_invoke");
...
fn c26_l64_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i32-hex-sep2", &[]).expect("Missing result in c26_l64_action_invoke");
...
fn c27_l66_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64-dec-sep1", &[]).expect("Missing result in c27_l66_action_invoke");
...
fn c28_l67_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64-dec-sep2", &[]).expect("Missing result in c28_l67_action_invoke");
...
fn c29_l68_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64-hex-sep1", &[]).expect("Missing result in c29_l68_action_invoke");
...
fn c30_l69_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("i64-hex-sep2", &[]).expect("Missing result in c30_l69_action_invoke");
