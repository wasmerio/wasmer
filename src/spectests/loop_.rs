...
fn c44_l359_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object
        .instance
        .call("while", &[Value::I64(20 as i64)])
