...
fn c1_l182_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-a", &[]).expect("Missing result in c1_l182_action_invoke");
...
fn c2_l183_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-b", &[]).expect("Missing result in c2_l183_action_invoke");
...
fn c3_l184_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-x", &[]).expect("Missing result in c3_l184_action_invoke");
...
fn c4_l185_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-y", &[]).expect("Missing result in c4_l185_action_invoke");
...
fn c5_l187_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-1", &[]).expect("Missing result in c5_l187_action_invoke");
...
fn c6_l188_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-2", &[]).expect("Missing result in c6_l188_action_invoke");
...
fn c7_l189_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-5", &[]).expect("Missing result in c7_l189_action_invoke");
...
fn c8_l190_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-6", &[]).expect("Missing result in c8_l190_action_invoke");
...
fn c9_l192_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("set-x", &[Value::I32(6 as i32)]).expect("Missing result in c9_l192_action_invoke");
...
fn c10_l193_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("set-y", &[Value::I64(7 as i64)]).expect("Missing result in c10_l193_action_invoke");
    assert_eq!(result, None);
}
...
fn c11_l194_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("set-5", &[Value::F32((8.0f32).to_bits())]).expect("Missing result in c11_l194_action_invoke");
    assert_eq!(result, None);
}
...
fn c12_l195_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("set-6", &[Value::F64((9.0f64).to_bits())]).expect("Missing result in c12_l195_action_invoke");
    assert_eq!(result, None);
}
...
fn c13_l197_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-x", &[]).expect("Missing result in c13_l197_action_invoke");
...
fn c14_l198_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-y", &[]).expect("Missing result in c14_l198_action_invoke");
...
fn c15_l199_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-5", &[]).expect("Missing result in c15_l199_action_invoke");
...
fn c16_l200_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-6", &[]).expect("Missing result in c16_l200_action_invoke");
...
fn c17_l202_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-select-first", &[]).expect("Missing result in c17_l202_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c18_l203_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-select-mid", &[]).expect("Missing result in c18_l203_action_invoke");
    assert_eq!(result, Some(Value::I32(2 as i32)));
}
...
fn c19_l204_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-select-last", &[]).expect("Missing result in c19_l204_action_invoke");
    assert_eq!(result, Some(Value::I32(2 as i32)));
}
...
fn c20_l206_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-loop-first", &[]).expect("Missing result in c20_l206_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c21_l207_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-loop-mid", &[]).expect("Missing result in c21_l207_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c22_l208_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-loop-last", &[]).expect("Missing result in c22_l208_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c23_l210_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-if-condition", &[]).expect("Missing result in c23_l210_action_invoke");
    assert_eq!(result, Some(Value::I32(2 as i32)));
}
...
fn c24_l211_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-if-then", &[]).expect("Missing result in c24_l211_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c25_l212_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-if-else", &[]).expect("Missing result in c25_l212_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c26_l214_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-br_if-first", &[]).expect("Missing result in c26_l214_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c27_l215_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-br_if-last", &[]).expect("Missing result in c27_l215_action_invoke");
    assert_eq!(result, Some(Value::I32(2 as i32)));
}
...
fn c28_l217_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-br_table-first", &[]).expect("Missing result in c28_l217_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c29_l218_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-br_table-last", &[]).expect("Missing result in c29_l218_action_invoke");
    assert_eq!(result, Some(Value::I32(2 as i32)));
}
...
fn c30_l220_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-call_indirect-first", &[]).expect("Missing result in c30_l220_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c31_l221_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-call_indirect-mid", &[]).expect("Missing result in c31_l221_action_invoke");
    assert_eq!(result, Some(Value::I32(2 as i32)));
}
...
fn c32_l222_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-call_indirect-last", &[]).expect("Missing result in c32_l222_action_invoke");
...
fn c33_l224_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-store-first", &[]).expect("Missing result in c33_l224_action_invoke");
    assert_eq!(result, None);
}
...
fn c34_l225_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-store-last", &[]).expect("Missing result in c34_l225_action_invoke");
    assert_eq!(result, None);
}
...
fn c35_l226_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-load-operand", &[]).expect("Missing result in c35_l226_action_invoke");
...
fn c36_l227_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-memory.grow-value", &[]).expect("Missing result in c36_l227_action_invoke");
    assert_eq!(result, Some(Value::I32(1 as i32)));
}
...
fn c37_l229_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-call-value", &[]).expect("Missing result in c37_l229_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c38_l231_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-return-value", &[]).expect("Missing result in c38_l231_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c39_l232_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-drop-operand", &[]).expect("Missing result in c39_l232_action_invoke");
    assert_eq!(result, None);
}
...
fn c40_l233_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-br-value", &[]).expect("Missing result in c40_l233_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c41_l235_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-set_local-value", &[Value::I32(1 as i32)]).expect("Missing result in c41_l235_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c42_l236_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-tee_local-value", &[Value::I32(1 as i32)]).expect("Missing result in c42_l236_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c43_l237_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-set_global-value", &[]).expect("Missing result in c43_l237_action_invoke");
    assert_eq!(result, Some(Value::I32(6 as i32)));
}
...
fn c44_l239_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-unary-operand", &[]).expect("Missing result in c44_l239_action_invoke");
...
fn c45_l240_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-binary-operand", &[]).expect("Missing result in c45_l240_action_invoke");
...
fn c46_l241_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("as-compare-operand", &[]).expect("Missing result in c46_l241_action_invoke");
    assert_eq!(result, Some(Value::I32(1 as i32)));
}
...
fn c60_l318_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-0", &[]).expect("Missing result in c60_l318_action_invoke");
...
fn c61_l319_action_invoke(result_object: &mut ResultObject) {
    ...
    let result = result_object.instance.call("get-0-ref", &[]).expect("Missing result in c61_l319_action_invoke");
    assert_eq!(result, Some(Value::I32(666 as i32)));
}
