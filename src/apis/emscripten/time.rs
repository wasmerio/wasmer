...
pub extern "C" fn _clock_gettime(clk_id: c_int, tp: c_int, instance: &mut Instance) -> c_int {
    ...
    // intentionally ignoring the clk_id and using the real-time clock
    // will revisit when we need to support different clocks
...
pub extern "C" fn _localtime(time_p: u32, instance: &mut Instance) -> c_int {
    ...
    unsafe {
        ...
        let result_addr = instance.memory_offset_addr(0, tm_struct_offset as _) as *mut guest_tm;
