...
test-all:
	$(CARGO_BINARY) nextest run $(CARGO_TARGET_FLAG) --workspace --release --no-default-features $(exclude_tests) --exclude wasmer-c-api-test-runner --exclude wasmer-capi-examples-runner $(test_compiler_features) --features $(test_all_features) --locked && \
	...
	$(CARGO_BINARY) test --doc $(CARGO_TARGET_FLAG) --workspace --release --no-default-features $(exclude_tests) --exclude wasmer-c-api-test-runner --exclude wasmer-capi-examples-runner $(test_compiler_features) --features $(test_all_features) --locked
