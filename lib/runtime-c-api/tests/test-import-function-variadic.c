...
// Parameters and results are defined as arrays
void print_str(const wasmer_instance_context_t *ctx, const wasmer_value_t params[], wasmer_value_t results[])
{
...
int main()
{
    ...
    wasmer_import_func_t *func = wasmer_import_func_variadic_new((void (*)(void *)) print_str, params_sig, 2, returns_sig, 0);
