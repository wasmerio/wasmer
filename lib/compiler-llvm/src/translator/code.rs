...
impl<'ctx> LLVMFunctionCodeGenerator<'ctx, '_> {
    ...
    fn trap_if_not_representable_as_int(
        ...
        self.build_call(self.intrinsics.throw_trap, &[trap_code.into()], "throw")?;
                ...
                .memory(memory_index, intrinsics, self.module, self.memory_styles)?
            {
                MemoryCache::Dynamic {
                        ...
                        || ptr_in_bounds.get_zero_extended_constant().unwrap() != 1
                    {
                        ...
                        let ptr_in_bounds = err!(self.build_call(
    ...
    fn translate_operator(&mut self, op: Operator, _source_loc: u32) -> Result<(), CompileError> {
        ...
        match op {
            ...
            Operator::F32Min => {
                ...
                let res = self
                    .build_call(self.intrinsics.minimum_f32, &[lhs.into(), rhs.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::F64Min => {
                ...
                let res = self
                    .build_call(self.intrinsics.minimum_f64, &[lhs.into(), rhs.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::F32x4Min => {
                ...
                let (v2, i2) = self.v128_into_f32x4(v2, i2)?;
                let res = self
                    .build_call(self.intrinsics.minimum_f32x4, &[v1.into(), v2.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::F64x2Min => {
                ...
                let (v2, i2) = self.v128_into_f64x2(v2, i2)?;
                let res = self
                    .build_call(self.intrinsics.minimum_f64x2, &[v1.into(), v2.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::F32Max => {
                ...
                let res = self
                    .build_call(self.intrinsics.maximum_f32, &[lhs.into(), rhs.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::F64Max => {
                ...
                let res = self
                    .build_call(self.intrinsics.maximum_f64, &[lhs.into(), rhs.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::F32x4Max => {
                ...
                let (v2, i2) = self.v128_into_f32x4(v2, i2)?;
                let res = self
                    .build_call(self.intrinsics.maximum_f32x4, &[v1.into(), v2.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::F64x2Max => {
                ...
                let (v2, i2) = self.v128_into_f64x2(v2, i2)?;
                let res = self
                    .build_call(self.intrinsics.maximum_f64x2, &[v1.into(), v2.into()], "")?
                    .try_as_basic_value()
                    .unwrap_basic();
            ...
            Operator::TryTable { try_table } => {
                ...
                if !lpad_clauses.is_empty() {
                    ...
                    let selector_value = self.build_call(
