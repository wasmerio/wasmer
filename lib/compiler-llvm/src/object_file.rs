...
static LIBCALLS_MACHO: phf::Map<&'static str, LibCall> = phf::phf_map! {
    ...
    "___divsi3" => LibCall::Divsi3,
    "___eqdf2" => LibCall::Eqdf2,
    "___eqsf2" => LibCall::Eqsf2,
    "___extendsfdf2" => LibCall::Extendsfdf2,
    "___fixdfdi" => LibCall::Fixdfdi,
    "___fixdfsi" => LibCall::Fixdfsi,
    "___fixsfdi" => LibCall::Fixsfdi,
    "___fixsfsi" => LibCall::Fixsfsi,
    "___fixunsdfdi" => LibCall::Fixunsdfdi,
    "___fixunsdfsi" => LibCall::Fixunsdfsi,
    "___fixunssfdi" => LibCall::Fixunssfdi,
    "___fixunssfsi" => LibCall::Fixunssfsi,
    "___floatdidf" => LibCall::Floatdidf,
    "___floatdisf" => LibCall::Floatdisf,
    "___floatsidf" => LibCall::Floatsidf,
    "___floatsisf" => LibCall::Floatsisf,
    "___floatundidf" => LibCall::Floatundidf,
    "___floatundisf" => LibCall::Floatundisf,
    "___floatunsidf" => LibCall::Floatunsidf,
    "___floatunsisf" => LibCall::Floatunsisf,
    "___gedf2" => LibCall::Gedf2,
    "___gesf2" => LibCall::Gesf2,
    "___gtdf2" => LibCall::Gtdf2,
    "___gtsf2" => LibCall::Gtsf2,
    "___ledf2" => LibCall::Ledf2,
    "___lesf2" => LibCall::Lesf2,
    "___ltdf2" => LibCall::Ltdf2,
    "___ltsf2" => LibCall::Ltsf2,
    "___moddi3" => LibCall::Moddi3,
    "___modsi3" => LibCall::Modsi3,
    ...
    "___nesf2" => LibCall::Nesf2,
    "___subdf3" => LibCall::Subdf3,
    "___subsf3" => LibCall::Subsf3,
    "___truncdfsf2" => LibCall::Truncdfsf2,
    "___udivdi3" => LibCall::Udivdi3,
    "___udivsi3" => LibCall::Udivsi3,
    "___umoddi3" => LibCall::Umoddi3,
