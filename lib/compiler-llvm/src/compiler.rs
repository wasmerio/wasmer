...
use wasmer_compiler::{
    ...
    Dwarf, ExperimentalNativeMetadataSerializer, FunctionBodyData, ModuleMiddleware,
    ModuleTranslationState, RelocationTarget, SectionBody, SectionIndex, Symbol, SymbolRegistry,
    Target,
};
