...
use crate::{NAPI_EXTENSION_WASMER_INTERFACE_NAME, NAPI_INTERFACE_NAME};
...
pub fn register_napi_imports(
    ...
    io.register_namespace(&NAPI_INTERFACE_NAME, napi_namespace);
    io.register_namespace(
        &NAPI_EXTENSION_WASMER_INTERFACE_NAME,
