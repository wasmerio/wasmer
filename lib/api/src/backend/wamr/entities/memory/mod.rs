...
impl Memory {
    ...
    pub(crate) fn to_vm_extern(&self) -> VMExtern {
        VMExtern::Wamr(unsafe { wasm_memory_as_extern(self.handle) })
    }
...
impl crate::Memory {
    /// Consume [`self`] into a [`crate::backend::wamr::memory::Memory`].
    pub fn into_wamr(self) -> crate::backend::wamr::memory::Memory {
        match self.0 {
