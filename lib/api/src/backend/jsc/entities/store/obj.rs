...
impl crate::StoreObjects {
    /// Consume [`self`] into [`crate::backend::jsc::store::StoreObjects`].
    ...
    /// Convert a reference to [`self`] into a reference [`crate::backend::jsc::store::StoreObjects`].
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::backend::jsc::store::StoreObjects`].
