        ...
        match extern_type {
            ExternType::Function(function_type) => {
                ...
                Ok(Self::Function(Function::from_vm_extern(
                    store,
                    crate::vm::VMExternFunction::Jsc(crate::rt::jsc::vm::VMExternFunction::new(
                        obj_val,
                        function_type.clone(),
                    )),
                )))
            ...
            ExternType::Global(global_type) => {
                ...
                Ok(Self::Global(crate::Global::from_vm_extern(
                    store,
                    crate::vm::VMExternGlobal::Jsc(crate::rt::jsc::vm::VMExternGlobal::new(
                        obj_val,
                        global_type.clone(),
                    )),
                )))
            ...
            ExternType::Memory(memory_type) => {
                ...
                Ok(Self::Memory(crate::Memory::from_vm_extern(
                    store,
                    crate::vm::VMExternMemory::Jsc(crate::rt::jsc::vm::VMExternMemory::new(
                        obj_val,
                        memory_type.clone(),
                    )),
                )))
            ...
            ExternType::Table(table_type) => {
                ...
                Ok(Self::Table(crate::Table::from_vm_extern(
                    store,
                    crate::vm::VMExternTable::Jsc(crate::rt::jsc::vm::VMExternTable::new(
                        obj_val,
                        table_type.clone(),
                    )),
                )))
