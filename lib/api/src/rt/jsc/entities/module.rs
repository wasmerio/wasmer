...
impl crate::Module {
    /// Consume [`self`] into a reference [`crate::rt::jsc::module::Module`].
    pub fn into_jsc(self) -> crate::rt::jsc::module::Module {
        match self.0 {
            RuntimeModule::Jsc(s) => s,
            _ => panic!("Not a `jsc` module!"),
        }
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::jsc::module::Module`].
    pub fn as_jsc(&self) -> &crate::rt::jsc::module::Module {
        match self.0 {
            RuntimeModule::Jsc(ref s) => s,
            _ => panic!("Not a `jsc` module!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::jsc::module::Module`].
    pub fn as_jsc_mut(&mut self) -> &mut crate::rt::jsc::module::Module {
        match self.0 {
            RuntimeModule::Jsc(ref mut s) => s,
            _ => panic!("Not a `jsc` module!"),
        }
    }
}
