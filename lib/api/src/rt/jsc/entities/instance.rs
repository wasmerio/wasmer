use crate::{
    ...
    AsStoreMut, Exports, Extern, Imports, InstantiationError, Module, RuntimeInstance,
};
...
impl crate::Instance {
    /// Consume [`self`] into [`crate::rt::jsc::instance::Instance`].
    pub fn into_jsc(self) -> crate::rt::jsc::instance::Instance {
        match self._inner {
            RuntimeInstance::Jsc(s) => s,
            _ => panic!("Not a `jsc` global!"),
        }
    }

    /// Convert a reference to [`self`] into a reference to [`crate::rt::jsc::instance::Instance`].
    pub fn as_jsc(&self) -> &crate::rt::jsc::instance::Instance {
        match self._inner {
            RuntimeInstance::Jsc(ref s) => s,
            _ => panic!("Not a `jsc` global!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference to [`crate::rt::jsc::instance::Instance`].
    pub fn as_jsc_mut(&mut self) -> &mut crate::rt::jsc::instance::Instance {
        match self._inner {
            RuntimeInstance::Jsc(ref mut s) => s,
            _ => panic!("Not a `jsc` global!"),
        }
    }
}
