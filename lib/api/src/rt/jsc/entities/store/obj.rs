...
impl crate::StoreObjects {
    /// Consume [`self`] into [`crate::rt::jsc::store::StoreObjects`].
    pub fn into_jsc(self) -> crate::rt::jsc::store::StoreObjects {
        match self {
            Self::Jsc(s) => s,
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::jsc::store::StoreObjects`].
    pub fn as_jsc(&self) -> &crate::rt::jsc::store::StoreObjects {
        match self {
            Self::Jsc(s) => s,
            _ => panic!("Not a `jsc` store!"),
        }
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::jsc::store::StoreObjects`].
    pub fn as_jsc_mut(&mut self) -> &mut crate::rt::jsc::store::StoreObjects {
        match self {
            Self::Jsc(s) => s,
            _ => panic!("Not a `jsc` store!"),
        }
