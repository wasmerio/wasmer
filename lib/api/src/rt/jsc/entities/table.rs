...
impl Table {
    ...
    pub fn to_vm_extern(&self) -> VMExtern {
        VMExtern::Jsc(crate::rt::jsc::vm::VMExtern::Table(self.handle.clone()))
    }
...
impl crate::Table {
    /// Consume [`self`] into [`crate::rt::jsc::table::Table`].
    pub fn into_jsc(self) -> crate::rt::jsc::table::Table {
        match self.0 {
            RuntimeTable::Jsc(s) => s,
            _ => panic!("Not a `jsc` table!"),
        }
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::jsc::table::Table`].
    pub fn as_jsc(&self) -> &crate::rt::jsc::table::Table {
        match self.0 {
            RuntimeTable::Jsc(ref s) => s,
            _ => panic!("Not a `jsc` table!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::jsc::table::Table`].
    pub fn as_jsc_mut(&mut self) -> &mut crate::rt::jsc::table::Table {
        match self.0 {
            RuntimeTable::Jsc(ref mut s) => s,
            _ => panic!("Not a `jsc` table!"),
        }
    }
}
