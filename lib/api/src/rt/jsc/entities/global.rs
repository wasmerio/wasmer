...
use crate::{
    ...
    vm::VMExtern,
    AsStoreMut, AsStoreRef, RuntimeError, RuntimeGlobal, Value,
};
...
impl Global {
    pub(crate) fn to_vm_extern(&self) -> VMExtern {
        VMExtern::Jsc(crate::rt::jsc::vm::VMExtern::Global(self.handle.clone()))
    }
    ...
    pub(crate) fn from_value(
        ...
        crate::rt::jsc::vm::VMGlobal::list_mut(store.objects_mut().as_jsc_mut())
...
impl crate::Global {
    /// Consume [`self`] into [`crate::rt::jsc::global::Global`].
    pub fn into_jsc(self) -> crate::rt::jsc::global::Global {
        match self.0 {
            RuntimeGlobal::Jsc(s) => s,
            _ => panic!("Not a `jsc` global!"),
        }
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::jsc::global::Global`].
    pub fn as_jsc(&self) -> &crate::rt::jsc::global::Global {
        match self.0 {
            RuntimeGlobal::Jsc(ref s) => s,
            _ => panic!("Not a `jsc` global!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::jsc::global::Global`].
    pub fn as_jsc_mut(&mut self) -> &mut crate::rt::jsc::global::Global {
        match self.0 {
            RuntimeGlobal::Jsc(ref mut s) => s,
            _ => panic!("Not a `jsc` global!"),
        }
    }
}
