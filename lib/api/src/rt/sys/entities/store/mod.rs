...
impl crate::RuntimeStore {
    /// Consume [`self`] into [`crate::rt::sys::store::Store`].
    pub fn into_sys(self) -> crate::rt::sys::store::Store {
        match self {
            Self::Sys(s) => s,
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::sys::store::Store`].
    pub fn as_sys(&self) -> &crate::rt::sys::store::Store {
        match self {
            Self::Sys(s) => s,
            _ => panic!("Not a `sys` store!"),
        }
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::sys::store::Store`].
    pub fn as_sys_mut(&mut self) -> &mut crate::rt::sys::store::Store {
        match self {
            Self::Sys(s) => s,
            _ => panic!("Not a `sys` store!"),
        }
...
impl crate::Store {
    /// Consume [`self`] into [`crate::rt::sys::store::Store`].
    pub(crate) fn into_sys(self) -> crate::rt::sys::store::Store {
        self.inner.store.into_sys()
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::sys::store::Store`].
    pub(crate) fn as_sys(&self) -> &crate::rt::sys::store::Store {
        self.inner.store.as_sys()
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::sys::store::Store`].
    pub(crate) fn as_sys_mut(&mut self) -> &mut crate::rt::sys::store::Store {
