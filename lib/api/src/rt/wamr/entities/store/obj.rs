...
use crate::{
    rt::wamr::vm::{VMFunctionEnvironment, VMGlobal},
    AsStoreMut,
};
...
impl crate::StoreObjects {
    /// Consume [`self`] into [`crate::rt::wamr::store::StoreObjects`].
    pub fn into_wamr(self) -> crate::rt::wamr::store::StoreObjects {
        match self {
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::wamr::store::StoreObjects`].
    pub fn as_wamr(&self) -> &crate::rt::wamr::store::StoreObjects {
        match self {
            crate::StoreObjects::Wamr(s) => s,
            _ => panic!("Not a `wamr` store!"),
        }
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::wamr::store::StoreObjects`].
    pub fn as_wamr_mut(&mut self) -> &mut crate::rt::wamr::store::StoreObjects {
        match self {
            crate::StoreObjects::Wamr(s) => s,
            _ => panic!("Not a `wamr` store!"),
        }
