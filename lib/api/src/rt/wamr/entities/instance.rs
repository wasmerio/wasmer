...
use crate::{
    rt::wamr::bindings::*, vm::VMExtern, wamr::error::Trap, AsStoreMut, AsStoreRef, Exports,
...
impl crate::RuntimeInstance {
    /// Consume [`self`] into a [`crate::rt::wamr::instance::Instance`].
    pub(crate) fn into_wamr(self) -> crate::rt::wamr::instance::Instance {
        match self {
            Self::Wamr(s) => s,
