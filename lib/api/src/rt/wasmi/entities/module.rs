...
use crate::{
    rt::wasmi::bindings::{wasm_byte_vec_t, wasm_module_delete, wasm_module_new, wasm_module_t},
...
impl crate::Module {
    /// Consume [`self`] into a reference [`crate::rt::wasmi::module::Module`].
    pub fn into_wasmi(self) -> crate::rt::wasmi::module::Module {
        match self.0 {
            RuntimeModule::Wasmi(s) => s,
            _ => panic!("Not a `wasmi` module!"),
        }
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::wasmi::module::Module`].
    pub fn as_wasmi(&self) -> &crate::rt::wasmi::module::Module {
        match self.0 {
            RuntimeModule::Wasmi(ref s) => s,
            _ => panic!("Not a `wasmi` module!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::wasmi::module::Module`].
    pub fn as_wasmi_mut(&mut self) -> &mut crate::rt::wasmi::module::Module {
        match self.0 {
            RuntimeModule::Wasmi(ref mut s) => s,
            _ => panic!("Not a `wasmi` module!"),
        }
    }
}
