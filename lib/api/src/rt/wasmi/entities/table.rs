...
impl crate::Table {
    /// Consume [`self`] into [`crate::rt::wasmi::table::Table`].
    pub fn into_wasmi(self) -> crate::rt::wasmi::table::Table {
        match self.0 {
            RuntimeTable::Wasmi(s) => s,
            _ => panic!("Not a `wasmi` table!"),
        }
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::wasmi::table::Table`].
    pub fn as_wasmi(&self) -> &crate::rt::wasmi::table::Table {
        match self.0 {
            RuntimeTable::Wasmi(ref s) => s,
            _ => panic!("Not a `wasmi` table!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::wasmi::table::Table`].
    pub fn as_wasmi_mut(&mut self) -> &mut crate::rt::wasmi::table::Table {
        match self.0 {
            RuntimeTable::Wasmi(ref mut s) => s,
            _ => panic!("Not a `wasmi` table!"),
        }
    }
}
