...
use crate::{
    rt::wasmi::vm::{VMFunctionEnvironment, VMGlobal},
    AsStoreMut,
};
...
impl crate::StoreObjects {
    /// Consume [`self`] into [`crate::rt::wasmi::store::StoreObjects`].
    pub fn into_wasmi(self) -> crate::rt::wasmi::store::StoreObjects {
        match self {
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::wasmi::store::StoreObjects`].
    pub fn as_wasmi(&self) -> &crate::rt::wasmi::store::StoreObjects {
        match self {
            crate::StoreObjects::Wasmi(s) => s,
            _ => panic!("Not a `wasmi` store!"),
        }
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::wasmi::store::StoreObjects`].
    pub fn as_wasmi_mut(&mut self) -> &mut crate::rt::wasmi::store::StoreObjects {
        match self {
            crate::StoreObjects::Wasmi(s) => s,
            _ => panic!("Not a `wasmi` store!"),
        }
