...
use crate::{
    ...
    rt::wasmi::bindings::{wasm_store_delete, wasm_store_new, wasm_store_t},
...
impl crate::RuntimeStore {
    /// Consume [`self`] into [`crate::rt::wasmi::store::Store`].
    pub fn into_wasmi(self) -> crate::rt::wasmi::store::Store {
        match self {
            Self::Wasmi(s) => s,
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::wasmi::store::Store`].
    pub fn as_wasmi(&self) -> &crate::rt::wasmi::store::Store {
        match self {
            Self::Wasmi(s) => s,
            _ => panic!("Not a `wasmi` store!"),
        }
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::wasmi::store::Store`].
    pub fn as_wasmi_mut(&mut self) -> &mut crate::rt::wasmi::store::Store {
        match self {
            Self::Wasmi(s) => s,
            _ => panic!("Not a `wasmi` store!"),
        }
...
impl crate::Store {
    /// Consume [`self`] into [`crate::rt::wasmi::store::Store`].
    pub(crate) fn into_wasmi(self) -> crate::rt::wasmi::store::Store {
        self.inner.store.into_wasmi()
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::wasmi::store::Store`].
    pub(crate) fn as_wasmi(&self) -> &crate::rt::wasmi::store::Store {
        self.inner.store.as_wasmi()
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::wasmi::store::Store`].
    pub(crate) fn as_wasmi_mut(&mut self) -> &mut crate::rt::wasmi::store::Store {
