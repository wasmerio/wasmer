...
use crate::{
    rt::wasmi::bindings::*, vm::VMExtern, wasmi::error::Trap, AsStoreMut, AsStoreRef, Exports,
...
impl crate::RuntimeInstance {
    /// Consume [`self`] into a [`crate::rt::wasmi::instance::Instance`].
    pub(crate) fn into_wasmi(self) -> crate::rt::wasmi::instance::Instance {
        match self {
            Self::Wasmi(s) => s,
