...
impl crate::StoreObjects {
    /// Consume [`self`] into [`crate::rt::js::store::StoreObjects`].
    pub fn into_js(self) -> crate::rt::js::store::StoreObjects {
        match self {
            Self::Js(s) => s,
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::js::store::StoreObjects`].
    pub fn as_js(&self) -> &crate::rt::js::store::StoreObjects {
        match self {
            Self::Js(s) => s,
            _ => panic!("Not a `js` store!"),
        }
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::js::store::StoreObjects`].
    pub fn as_js_mut(&mut self) -> &mut crate::rt::js::store::StoreObjects {
        match self {
            Self::Js(s) => s,
            _ => panic!("Not a `js` store!"),
        }
