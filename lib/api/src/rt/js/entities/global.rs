...
impl crate::Global {
    /// Consume [`self`] into [`crate::rt::js::global::Global`].
    pub fn into_js(self) -> crate::rt::js::global::Global {
        match self.0 {
            RuntimeGlobal::Js(s) => s,
            _ => panic!("Not a `js` global!"),
        }
    }

    /// Convert a reference to [`self`] into a reference [`crate::rt::js::global::Global`].
    pub fn as_js(&self) -> &crate::rt::js::global::Global {
        match self.0 {
            RuntimeGlobal::Js(ref s) => s,
            _ => panic!("Not a `js` global!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::js::global::Global`].
    pub fn as_js_mut(&mut self) -> &mut crate::rt::js::global::Global {
        match self.0 {
            RuntimeGlobal::Js(ref mut s) => s,
            _ => panic!("Not a `js` global!"),
        }
    }
}
