...
use crate::{
    ...
    AsStoreMut, AsStoreRef, RuntimeMemory,
};
...
impl From<Memory> for crate::Memory {
    fn from(value: Memory) -> Self {
        crate::Memory(crate::RuntimeMemory::Js(value))
    }
}
...
impl crate::Memory {
    /// Consume [`self`] into a [`crate::rt::js::mem::Memory`].
    pub fn into_js(self) -> crate::rt::js::memory::Memory {
        match self.0 {
            RuntimeMemory::Js(s) => s,
            _ => panic!("Not a `js` memory!"),
        }
    }

    /// Convert a reference to [`self`] into a reference to [`crate::rt::js::mem::Memory`].
    pub fn as_js(&self) -> &crate::rt::js::memory::Memory {
        match self.0 {
            RuntimeMemory::Js(ref s) => s,
            _ => panic!("Not a `js` memory!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference to [`crate::rt::js::mem::Memory`].
    pub fn as_js_mut(&mut self) -> &mut crate::rt::js::memory::Memory {
        match self.0 {
            RuntimeMemory::Js(ref mut s) => s,
            _ => panic!("Not a `js` memory!"),
        }
    }
}
