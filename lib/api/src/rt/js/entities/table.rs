...
impl crate::Table {
    /// Consume [`self`] into [`crate::rt::js::table::Table`].
    pub fn into_js(self) -> crate::rt::js::table::Table {
        match self.0 {
            RuntimeTable::Js(s) => s,
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::js::table::Table`].
    pub fn as_js(&self) -> &crate::rt::js::table::Table {
        match self.0 {
            RuntimeTable::Js(ref s) => s,
            _ => panic!("Not a `js` table!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::js::table::Table`].
    pub fn as_js_mut(&mut self) -> &mut crate::rt::js::table::Table {
        match self.0 {
            RuntimeTable::Js(ref mut s) => s,
            _ => panic!("Not a `js` table!"),
        }
    }
}
