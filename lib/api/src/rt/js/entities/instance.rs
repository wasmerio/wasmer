...
impl crate::Instance {
    /// Consume [`self`] into [`crate::rt::js::instance::Instance`].
    pub fn into_js(self) -> crate::rt::js::instance::Instance {
        match self._inner {
            RuntimeInstance::Js(s) => s,
            _ => panic!("Not a `js` global!"),
        }
    }

    /// Convert a reference to [`self`] into a reference to [`crate::rt::js::instance::Instance`].
    pub fn as_js(&self) -> &crate::rt::js::instance::Instance {
        match self._inner {
            RuntimeInstance::Js(ref s) => s,
            _ => panic!("Not a `js` global!"),
        }
    }

    /// Convert a mutable reference to [`self`] into a mutable reference to [`crate::rt::js::instance::Instance`].
    pub fn as_js_mut(&mut self) -> &mut crate::rt::js::instance::Instance {
        match self._inner {
            RuntimeInstance::Js(ref mut s) => s,
            _ => panic!("Not a `js` global!"),
        }
    }
}
