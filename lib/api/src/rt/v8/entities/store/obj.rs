...
use crate::{
    rt::v8::vm::{VMFunctionEnvironment, VMGlobal},
    AsStoreMut,
};
...
impl crate::StoreObjects {
    /// Consume [`self`] into [`crate::rt::v8::store::StoreObjects`].
    pub fn into_v8(self) -> crate::rt::v8::store::StoreObjects {
        match self {
    ...
    /// Convert a reference to [`self`] into a reference [`crate::rt::v8::store::StoreObjects`].
    pub fn as_v8(&self) -> &crate::rt::v8::store::StoreObjects {
        match self {
            crate::StoreObjects::V8(s) => s,
            _ => panic!("Not a `v8` store!"),
        }
    ...
    /// Convert a mutable reference to [`self`] into a mutable reference [`crate::rt::v8::store::StoreObjects`].
    pub fn as_v8_mut(&mut self) -> &mut crate::rt::v8::store::StoreObjects {
        match self {
            crate::StoreObjects::V8(s) => s,
            _ => panic!("Not a `v8` store!"),
        }
