    ...
    (func (export "call_host_func8")
        ...
        let imports = imports! {
            "host" => {
                ...
                "host_func2" => Function::new_native(&mut store, &ctx,|_ctx: FunctionEnvMut<()>, p: u32| {
                    println!("host_func2: Found number {}", p);
                    assert_eq!(p, u32::max_value());
                }),
                "host_func3" => Function::new_native(&mut store, &ctx,|_ctx: FunctionEnvMut<()>, p: i64| {
                    println!("host_func3: Found number {}", p);
                    assert_eq!(p, -1);
                }),
                "host_func4" => Function::new_native(&mut store, &ctx,|_ctx: FunctionEnvMut<()>, p: i32| {
                    println!("host_func4: Found number {}", p);
                    assert_eq!(p, -1);
                }),
                "host_func5" => Function::new_native(&mut store, &ctx,|_ctx: FunctionEnvMut<()>, p: i16| {
                    println!("host_func5: Found number {}", p);
                    assert_eq!(p, -1);
                }),
                "host_func6" => Function::new_native(&mut store, &ctx,|_ctx: FunctionEnvMut<()>, p: u16| {
                    println!("host_func6: Found number {}", p);
                    assert_eq!(p, u16::max_value());
                }),
                "host_func7" => Function::new_native(&mut store, &ctx,|_ctx: FunctionEnvMut<()>, p: i8| {
                    println!("host_func7: Found number {}", p);
                    assert_eq!(p, -1);
                }),
                "host_func8" => Function::new_native(&mut store, &ctx,|_ctx: FunctionEnvMut<()>, p: u8| {
