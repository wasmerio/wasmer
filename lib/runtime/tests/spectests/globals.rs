...
// Line 182
fn c1_l182_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c1_l182_action_invoke");
    let result = instance.call("get-a", &[]);
    assert_eq!(result, Ok(Some(Value::I32(-2 as i32))));
    result.map(|_| ())
}

// Line 183
fn c2_l183_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c2_l183_action_invoke");
    let result = instance.call("get-b", &[]);
    assert_eq!(result, Ok(Some(Value::I64(-5 as i64))));
    result.map(|_| ())
}

// Line 184
fn c3_l184_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c3_l184_action_invoke");
    let result = instance.call("get-x", &[]);
    assert_eq!(result, Ok(Some(Value::I32(-12 as i32))));
    result.map(|_| ())
}

// Line 185
fn c4_l185_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c4_l185_action_invoke");
    let result = instance.call("get-y", &[]);
...
// Line 192
fn c9_l192_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c9_l192_action_invoke");
    let result = instance.call("set-x", &[Value::I32(6 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 193
fn c10_l193_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c10_l193_action_invoke");
    let result = instance.call("set-y", &[Value::I64(7 as i64)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}
...
// Line 197
fn c13_l197_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 198
fn c14_l198_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 202
fn c17_l202_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 203
fn c18_l203_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 204
fn c19_l204_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 206
fn c20_l206_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 207
fn c21_l207_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 208
fn c22_l208_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 210
fn c23_l210_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 211
fn c24_l211_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 212
fn c25_l212_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 214
fn c26_l214_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 215
fn c27_l215_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 217
fn c28_l217_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 218
fn c29_l218_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 220
fn c30_l220_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 221
fn c31_l221_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
fn c32_l222_assert_trap() {
    ...
    let result = c32_l222_action_invoke(&mut instance);
    assert!(result.is_err());
}

// Line 224
fn c33_l224_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 225
fn c34_l225_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 226
fn c35_l226_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 227
fn c36_l227_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 229
fn c37_l229_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 231
fn c38_l231_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 232
fn c39_l232_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 233
fn c40_l233_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 235
fn c41_l235_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 236
fn c42_l236_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 237
fn c43_l237_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 239
fn c44_l239_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 240
fn c45_l240_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c45_l240_action_invoke");
    let result = instance.call("as-binary-operand", &[]);
    assert_eq!(result, Ok(Some(Value::I32(36 as i32))));
    result.map(|_| ())
}

// Line 241
fn c46_l241_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
fn test_module_1() {
    ...
    c1_l182_action_invoke(&mut instance);
    c2_l183_action_invoke(&mut instance);
    c3_l184_action_invoke(&mut instance);
    c4_l185_action_invoke(&mut instance);
    c5_l187_action_invoke(&mut instance);
    c6_l188_action_invoke(&mut instance);
    c7_l189_action_invoke(&mut instance);
    c8_l190_action_invoke(&mut instance);
    c9_l192_action_invoke(&mut instance);
    c10_l193_action_invoke(&mut instance);
    c11_l194_action_invoke(&mut instance);
    c12_l195_action_invoke(&mut instance);
    c13_l197_action_invoke(&mut instance);
    c14_l198_action_invoke(&mut instance);
    c15_l199_action_invoke(&mut instance);
    c16_l200_action_invoke(&mut instance);
    c17_l202_action_invoke(&mut instance);
    c18_l203_action_invoke(&mut instance);
    c19_l204_action_invoke(&mut instance);
    c20_l206_action_invoke(&mut instance);
    c21_l207_action_invoke(&mut instance);
    c22_l208_action_invoke(&mut instance);
    c23_l210_action_invoke(&mut instance);
    c24_l211_action_invoke(&mut instance);
    c25_l212_action_invoke(&mut instance);
    c26_l214_action_invoke(&mut instance);
    c27_l215_action_invoke(&mut instance);
    c28_l217_action_invoke(&mut instance);
    c29_l218_action_invoke(&mut instance);
    c30_l220_action_invoke(&mut instance);
    c31_l221_action_invoke(&mut instance);
    c33_l224_action_invoke(&mut instance);
    c34_l225_action_invoke(&mut instance);
    c35_l226_action_invoke(&mut instance);
    c36_l227_action_invoke(&mut instance);
    c37_l229_action_invoke(&mut instance);
    c38_l231_action_invoke(&mut instance);
    c39_l232_action_invoke(&mut instance);
    c40_l233_action_invoke(&mut instance);
    c41_l235_action_invoke(&mut instance);
    c42_l236_action_invoke(&mut instance);
    c43_l237_action_invoke(&mut instance);
    c44_l239_action_invoke(&mut instance);
    c45_l240_action_invoke(&mut instance);
    c46_l241_action_invoke(&mut instance);
}
...
// Line 318
fn c60_l318_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c60_l318_action_invoke");
    let result = instance.call("get-0", &[]);
    assert_eq!(result, Ok(Some(Value::I32(666 as i32))));
    result.map(|_| ())
}

// Line 319
fn c61_l319_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
fn test_module_2() {
    ...
    c60_l318_action_invoke(&mut instance);
    c61_l319_action_invoke(&mut instance);
}
