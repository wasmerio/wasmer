...
// Line 98
fn c1_l98_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 99
fn c2_l99_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 100
fn c3_l100_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 101
fn c4_l101_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 103
fn c5_l103_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
fn c7_l105_action_invoke(instance: &mut Instance) -> Result<(), String> {
    ...
    assert_eq!(result, Ok(Some(Value::F32((11.1f32)))));
    result.map(|_| ())
}

// Line 106
fn c8_l106_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c8_l106_action_invoke");
    let result = instance.call("type-param-f64", &[Value::F64((5.5f64))]);
    assert_eq!(result, Ok(Some(Value::F64((12.2f64)))));
    result.map(|_| ())
}

// Line 109
fn c9_l109_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 115
fn c10_l115_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 122
fn c11_l122_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
fn test_module_1() {
    ...
    c1_l98_action_invoke(&mut instance);
    c2_l99_action_invoke(&mut instance);
    c3_l100_action_invoke(&mut instance);
    c4_l101_action_invoke(&mut instance);
    c5_l103_action_invoke(&mut instance);
    c6_l104_action_invoke(&mut instance);
    c7_l105_action_invoke(&mut instance);
    c8_l106_action_invoke(&mut instance);
    c9_l109_action_invoke(&mut instance);
    c10_l115_action_invoke(&mut instance);
    c11_l122_action_invoke(&mut instance);
}
