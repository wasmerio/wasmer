...
// Line 84
fn c1_l84_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c1_l84_action_invoke");
    let result = instance.call("fac-rec", &[Value::I64(25 as i64)]);
    assert_eq!(result, Ok(Some(Value::I64(7034535277573963776 as i64))));
    result.map(|_| ())
}

// Line 85
fn c2_l85_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c2_l85_action_invoke");
    let result = instance.call("fac-iter", &[Value::I64(25 as i64)]);
    assert_eq!(result, Ok(Some(Value::I64(7034535277573963776 as i64))));
    result.map(|_| ())
}

// Line 86
fn c3_l86_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c3_l86_action_invoke");
    let result = instance.call("fac-rec-named", &[Value::I64(25 as i64)]);
    assert_eq!(result, Ok(Some(Value::I64(7034535277573963776 as i64))));
    result.map(|_| ())
}

// Line 87
fn c4_l87_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c4_l87_action_invoke");
    let result = instance.call("fac-iter-named", &[Value::I64(25 as i64)]);
    assert_eq!(result, Ok(Some(Value::I64(7034535277573963776 as i64))));
    result.map(|_| ())
}

// Line 88
fn c5_l88_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c5_l88_action_invoke");
    let result = instance.call("fac-opt", &[Value::I64(25 as i64)]);
    assert_eq!(result, Ok(Some(Value::I64(7034535277573963776 as i64))));
    result.map(|_| ())
}
...
fn test_module_1() {
    ...
    c1_l84_action_invoke(&mut instance);
    c2_l85_action_invoke(&mut instance);
    c3_l86_action_invoke(&mut instance);
    c4_l87_action_invoke(&mut instance);
    c5_l88_action_invoke(&mut instance);
}
