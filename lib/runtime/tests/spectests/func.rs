...
// Line 171
fn c1_l171_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c1_l171_action_invoke");
    let result = instance.call("type-use-1", &[]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 172
fn c2_l172_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c2_l172_action_invoke");
    let result = instance.call("type-use-2", &[]);
    assert_eq!(result, Ok(Some(Value::I32(0 as i32))));
    result.map(|_| ())
}

// Line 173
fn c3_l173_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c3_l173_action_invoke");
    let result = instance.call("type-use-3", &[Value::I32(1 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 175
fn c4_l175_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c4_l175_action_invoke");
    let result = instance.call("type-use-4", &[Value::I32(1 as i32), Value::F64((1.0f64).to_bits()), Value::I32(1 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(0 as i32))));
    result.map(|_| ())
}

// Line 178
fn c5_l178_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c5_l178_action_invoke");
    let result = instance.call("type-use-5", &[]);
    assert_eq!(result, Ok(Some(Value::I32(0 as i32))));
    result.map(|_| ())
}
...
fn c6_l179_action_invoke(instance: &mut Instance) -> Result<(), String> {
    ...
    let result = instance.call("type-use-6", &[Value::I32(1 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 181
fn c7_l181_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c7_l181_action_invoke");
    let result = instance.call("type-use-7", &[Value::I32(1 as i32), Value::F64((1.0f64).to_bits()), Value::I32(1 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(0 as i32))));
    result.map(|_| ())
}

// Line 185
fn c8_l185_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c8_l185_action_invoke");
    let result = instance.call("local-first-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(0 as i32))));
    result.map(|_| ())
}

// Line 186
fn c9_l186_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c9_l186_action_invoke");
    let result = instance.call("local-first-i64", &[]);
    assert_eq!(result, Ok(Some(Value::I64(0 as i64))));
    result.map(|_| ())
}

// Line 187
fn c10_l187_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c10_l187_action_invoke");
    let result = instance.call("local-first-f32", &[]);
    assert_eq!(result, Ok(Some(Value::F32((0.0f32).to_bits()))));
    result.map(|_| ())
}

// Line 188
fn c11_l188_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c11_l188_action_invoke");
    let result = instance.call("local-first-f64", &[]);
    assert_eq!(result, Ok(Some(Value::F64((0.0f64).to_bits()))));
    result.map(|_| ())
}

// Line 189
fn c12_l189_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c12_l189_action_invoke");
    let result = instance.call("local-second-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(0 as i32))));
    result.map(|_| ())
}

// Line 190
fn c13_l190_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c13_l190_action_invoke");
    let result = instance.call("local-second-i64", &[]);
    assert_eq!(result, Ok(Some(Value::I64(0 as i64))));
    result.map(|_| ())
}

// Line 191
fn c14_l191_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c14_l191_action_invoke");
    let result = instance.call("local-second-f32", &[]);
    assert_eq!(result, Ok(Some(Value::F32((0.0f32).to_bits()))));
    result.map(|_| ())
}

// Line 192
fn c15_l192_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c15_l192_action_invoke");
    let result = instance.call("local-second-f64", &[]);
    assert_eq!(result, Ok(Some(Value::F64((0.0f64).to_bits()))));
    result.map(|_| ())
}

// Line 193
fn c16_l193_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c16_l193_action_invoke");
    let result = instance.call("local-mixed", &[]);
    assert_eq!(result, Ok(Some(Value::F64((0.0f64).to_bits()))));
    result.map(|_| ())
}

// Line 196
fn c17_l196_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c17_l196_action_invoke");
    let result = instance.call("param-first-i32", &[Value::I32(2 as i32), Value::I32(3 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(2 as i32))));
    result.map(|_| ())
}

// Line 199
fn c18_l199_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c18_l199_action_invoke");
    let result = instance.call("param-first-i64", &[Value::I64(2 as i64), Value::I64(3 as i64)]);
    assert_eq!(result, Ok(Some(Value::I64(2 as i64))));
    result.map(|_| ())
}

// Line 202
fn c19_l202_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c19_l202_action_invoke");
    let result = instance.call("param-first-f32", &[Value::F32((2.0f32).to_bits()), Value::F32((3.0f32).to_bits())]);
    assert_eq!(result, Ok(Some(Value::F32((2.0f32).to_bits()))));
    result.map(|_| ())
}

// Line 205
fn c20_l205_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c20_l205_action_invoke");
    let result = instance.call("param-first-f64", &[Value::F64((2.0f64).to_bits()), Value::F64((3.0f64).to_bits())]);
    assert_eq!(result, Ok(Some(Value::F64((2.0f64).to_bits()))));
    result.map(|_| ())
}

// Line 208
fn c21_l208_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c21_l208_action_invoke");
    let result = instance.call("param-second-i32", &[Value::I32(2 as i32), Value::I32(3 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(3 as i32))));
    result.map(|_| ())
}

// Line 211
fn c22_l211_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c22_l211_action_invoke");
    let result = instance.call("param-second-i64", &[Value::I64(2 as i64), Value::I64(3 as i64)]);
    assert_eq!(result, Ok(Some(Value::I64(3 as i64))));
    result.map(|_| ())
}

// Line 214
fn c23_l214_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c23_l214_action_invoke");
    let result = instance.call("param-second-f32", &[Value::F32((2.0f32).to_bits()), Value::F32((3.0f32).to_bits())]);
    assert_eq!(result, Ok(Some(Value::F32((3.0f32).to_bits()))));
    result.map(|_| ())
}

// Line 217
fn c24_l217_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c24_l217_action_invoke");
    let result = instance.call("param-second-f64", &[Value::F64((2.0f64).to_bits()), Value::F64((3.0f64).to_bits())]);
    assert_eq!(result, Ok(Some(Value::F64((3.0f64).to_bits()))));
    result.map(|_| ())
}

// Line 221
fn c25_l221_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c25_l221_action_invoke");
    let result = instance.call("param-mixed", &[Value::F32((1.0f32).to_bits()), Value::I32(2 as i32), Value::I64(3 as i64), Value::I32(4 as i32), Value::F64((5.5f64).to_bits()), Value::I32(6 as i32)]);
    assert_eq!(result, Ok(Some(Value::F64((5.5f64).to_bits()))));
    result.map(|_| ())
}

// Line 228
fn c26_l228_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 229
fn c27_l229_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c27_l229_action_invoke");
    let result = instance.call("value-void", &[]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 230
fn c28_l230_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c28_l230_action_invoke");
    let result = instance.call("value-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(77 as i32))));
    result.map(|_| ())
}

// Line 231
fn c29_l231_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c29_l231_action_invoke");
    let result = instance.call("value-i64", &[]);
    assert_eq!(result, Ok(Some(Value::I64(7777 as i64))));
    result.map(|_| ())
}

// Line 232
fn c30_l232_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c30_l232_action_invoke");
    let result = instance.call("value-f32", &[]);
    assert_eq!(result, Ok(Some(Value::F32((77.7f32).to_bits()))));
    result.map(|_| ())
}

// Line 233
fn c31_l233_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c31_l233_action_invoke");
    let result = instance.call("value-f64", &[]);
    assert_eq!(result, Ok(Some(Value::F64((77.77f64).to_bits()))));
    result.map(|_| ())
}

// Line 234
fn c32_l234_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c32_l234_action_invoke");
    let result = instance.call("value-block-void", &[]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 235
fn c33_l235_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c33_l235_action_invoke");
    let result = instance.call("value-block-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(77 as i32))));
    result.map(|_| ())
}

// Line 237
fn c34_l237_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c34_l237_action_invoke");
    let result = instance.call("return-empty", &[]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 238
fn c35_l238_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c35_l238_action_invoke");
    let result = instance.call("return-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(78 as i32))));
    result.map(|_| ())
}

// Line 239
fn c36_l239_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c36_l239_action_invoke");
    let result = instance.call("return-i64", &[]);
    assert_eq!(result, Ok(Some(Value::I64(7878 as i64))));
    result.map(|_| ())
}

// Line 240
fn c37_l240_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c37_l240_action_invoke");
    let result = instance.call("return-f32", &[]);
    assert_eq!(result, Ok(Some(Value::F32((78.7f32).to_bits()))));
    result.map(|_| ())
}

// Line 241
fn c38_l241_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c38_l241_action_invoke");
    let result = instance.call("return-f64", &[]);
    assert_eq!(result, Ok(Some(Value::F64((78.78f64).to_bits()))));
    result.map(|_| ())
}

// Line 242
fn c39_l242_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c39_l242_action_invoke");
    let result = instance.call("return-block-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(77 as i32))));
    result.map(|_| ())
}

// Line 244
fn c40_l244_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c40_l244_action_invoke");
    let result = instance.call("break-empty", &[]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 245
fn c41_l245_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c41_l245_action_invoke");
    let result = instance.call("break-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(79 as i32))));
    result.map(|_| ())
}

// Line 246
fn c42_l246_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c42_l246_action_invoke");
    let result = instance.call("break-i64", &[]);
    assert_eq!(result, Ok(Some(Value::I64(7979 as i64))));
    result.map(|_| ())
}

// Line 247
fn c43_l247_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c43_l247_action_invoke");
    let result = instance.call("break-f32", &[]);
    assert_eq!(result, Ok(Some(Value::F32((79.9f32).to_bits()))));
    result.map(|_| ())
}

// Line 248
fn c44_l248_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c44_l248_action_invoke");
    let result = instance.call("break-f64", &[]);
    assert_eq!(result, Ok(Some(Value::F64((79.79f64).to_bits()))));
    result.map(|_| ())
}
...
fn c45_l249_action_invoke(instance: &mut Instance) -> Result<(), String> {
    ...
    let result = instance.call("break-block-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(77 as i32))));
    result.map(|_| ())
}

// Line 251
fn c46_l251_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c46_l251_action_invoke");
    let result = instance.call("break-br_if-empty", &[Value::I32(0 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 252
fn c47_l252_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c47_l252_action_invoke");
    let result = instance.call("break-br_if-empty", &[Value::I32(2 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 253
fn c48_l253_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c48_l253_action_invoke");
    let result = instance.call("break-br_if-num", &[Value::I32(0 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(51 as i32))));
    result.map(|_| ())
}

// Line 254
fn c49_l254_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c49_l254_action_invoke");
    let result = instance.call("break-br_if-num", &[Value::I32(1 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(50 as i32))));
    result.map(|_| ())
}

// Line 256
fn c50_l256_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c50_l256_action_invoke");
    let result = instance.call("break-br_table-empty", &[Value::I32(0 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 257
fn c51_l257_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c51_l257_action_invoke");
    let result = instance.call("break-br_table-empty", &[Value::I32(1 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 258
fn c52_l258_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c52_l258_action_invoke");
    let result = instance.call("break-br_table-empty", &[Value::I32(5 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 259
fn c53_l259_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 260
fn c54_l260_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c54_l260_action_invoke");
    let result = instance.call("break-br_table-num", &[Value::I32(0 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(50 as i32))));
    result.map(|_| ())
}

// Line 261
fn c55_l261_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c55_l261_action_invoke");
    let result = instance.call("break-br_table-num", &[Value::I32(1 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(50 as i32))));
    result.map(|_| ())
}

// Line 262
fn c56_l262_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c56_l262_action_invoke");
    let result = instance.call("break-br_table-num", &[Value::I32(10 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(50 as i32))));
    result.map(|_| ())
}

// Line 263
fn c57_l263_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c57_l263_action_invoke");
    let result = instance.call("break-br_table-num", &[Value::I32(-100 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(50 as i32))));
    result.map(|_| ())
}

// Line 264
fn c58_l264_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c58_l264_action_invoke");
    let result = instance.call("break-br_table-nested-empty", &[Value::I32(0 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 265
fn c59_l265_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c59_l265_action_invoke");
    let result = instance.call("break-br_table-nested-empty", &[Value::I32(1 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 266
fn c60_l266_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c60_l266_action_invoke");
    let result = instance.call("break-br_table-nested-empty", &[Value::I32(3 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 267
fn c61_l267_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c61_l267_action_invoke");
    let result = instance.call("break-br_table-nested-empty", &[Value::I32(-2 as i32)]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 269
fn c62_l269_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c62_l269_action_invoke");
    let result = instance.call("break-br_table-nested-num", &[Value::I32(0 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(52 as i32))));
    result.map(|_| ())
}

// Line 272
fn c63_l272_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c63_l272_action_invoke");
    let result = instance.call("break-br_table-nested-num", &[Value::I32(1 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(50 as i32))));
    result.map(|_| ())
}

// Line 275
fn c64_l275_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c64_l275_action_invoke");
    let result = instance.call("break-br_table-nested-num", &[Value::I32(2 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(52 as i32))));
    result.map(|_| ())
}

// Line 278
fn c65_l278_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c65_l278_action_invoke");
    let result = instance.call("break-br_table-nested-num", &[Value::I32(-3 as i32)]);
    assert_eq!(result, Ok(Some(Value::I32(52 as i32))));
    result.map(|_| ())
}
...
fn c66_l281_action_invoke(instance: &mut Instance) -> Result<(), String> {
    ...
    let result = instance.call("init-local-i32", &[]);
    assert_eq!(result, Ok(Some(Value::I32(0 as i32))));
    result.map(|_| ())
}

// Line 282
fn c67_l282_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c67_l282_action_invoke");
    let result = instance.call("init-local-i64", &[]);
    assert_eq!(result, Ok(Some(Value::I64(0 as i64))));
    result.map(|_| ())
}

// Line 283
fn c68_l283_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c68_l283_action_invoke");
    let result = instance.call("init-local-f32", &[]);
    assert_eq!(result, Ok(Some(Value::F32((0.0f32).to_bits()))));
    result.map(|_| ())
}

// Line 284
fn c69_l284_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c69_l284_action_invoke");
    let result = instance.call("init-local-f64", &[]);
    assert_eq!(result, Ok(Some(Value::F64((0.0f64).to_bits()))));
    result.map(|_| ())
}
...
fn test_module_1() {
    ...
    c1_l171_action_invoke(&mut instance);
    c2_l172_action_invoke(&mut instance);
    c3_l173_action_invoke(&mut instance);
    c4_l175_action_invoke(&mut instance);
    c5_l178_action_invoke(&mut instance);
    c6_l179_action_invoke(&mut instance);
    c7_l181_action_invoke(&mut instance);
    c8_l185_action_invoke(&mut instance);
    c9_l186_action_invoke(&mut instance);
    c10_l187_action_invoke(&mut instance);
    c11_l188_action_invoke(&mut instance);
    c12_l189_action_invoke(&mut instance);
    c13_l190_action_invoke(&mut instance);
    c14_l191_action_invoke(&mut instance);
    c15_l192_action_invoke(&mut instance);
    c16_l193_action_invoke(&mut instance);
    c17_l196_action_invoke(&mut instance);
    c18_l199_action_invoke(&mut instance);
    c19_l202_action_invoke(&mut instance);
    c20_l205_action_invoke(&mut instance);
    c21_l208_action_invoke(&mut instance);
    c22_l211_action_invoke(&mut instance);
    c23_l214_action_invoke(&mut instance);
    c24_l217_action_invoke(&mut instance);
    c25_l221_action_invoke(&mut instance);
    c26_l228_action_invoke(&mut instance);
    c27_l229_action_invoke(&mut instance);
    c28_l230_action_invoke(&mut instance);
    c29_l231_action_invoke(&mut instance);
    c30_l232_action_invoke(&mut instance);
    c31_l233_action_invoke(&mut instance);
    c32_l234_action_invoke(&mut instance);
    c33_l235_action_invoke(&mut instance);
    c34_l237_action_invoke(&mut instance);
    c35_l238_action_invoke(&mut instance);
    c36_l239_action_invoke(&mut instance);
    c37_l240_action_invoke(&mut instance);
    c38_l241_action_invoke(&mut instance);
    c39_l242_action_invoke(&mut instance);
    c40_l244_action_invoke(&mut instance);
    c41_l245_action_invoke(&mut instance);
    c42_l246_action_invoke(&mut instance);
    c43_l247_action_invoke(&mut instance);
    c44_l248_action_invoke(&mut instance);
    c45_l249_action_invoke(&mut instance);
    c46_l251_action_invoke(&mut instance);
    c47_l252_action_invoke(&mut instance);
    c48_l253_action_invoke(&mut instance);
    c49_l254_action_invoke(&mut instance);
    c50_l256_action_invoke(&mut instance);
    c51_l257_action_invoke(&mut instance);
    c52_l258_action_invoke(&mut instance);
    c53_l259_action_invoke(&mut instance);
    c54_l260_action_invoke(&mut instance);
    c55_l261_action_invoke(&mut instance);
    c56_l262_action_invoke(&mut instance);
    c57_l263_action_invoke(&mut instance);
    c58_l264_action_invoke(&mut instance);
    c59_l265_action_invoke(&mut instance);
    c60_l266_action_invoke(&mut instance);
    c61_l267_action_invoke(&mut instance);
    c62_l269_action_invoke(&mut instance);
    c63_l272_action_invoke(&mut instance);
    c64_l275_action_invoke(&mut instance);
    c65_l278_action_invoke(&mut instance);
    c66_l281_action_invoke(&mut instance);
    c67_l282_action_invoke(&mut instance);
    c68_l283_action_invoke(&mut instance);
    c69_l284_action_invoke(&mut instance);
}
...
// Line 378
fn c73_l378_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 379
fn c74_l379_action_invoke(instance: &mut Instance) -> Result<(), String> {
...
// Line 380
fn c75_l380_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c75_l380_action_invoke");
    let result = instance.call("signature-explicit-duplicate", &[]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}

// Line 381
fn c76_l381_action_invoke(instance: &mut Instance) -> Result<(), String> {
    println!("Executing function {}", "c76_l381_action_invoke");
    let result = instance.call("signature-implicit-duplicate", &[]);
    assert_eq!(result, Ok(None));
    result.map(|_| ())
}
...
fn test_module_3() {
    ...
    c73_l378_action_invoke(&mut instance);
    c74_l379_action_invoke(&mut instance);
    c75_l380_action_invoke(&mut instance);
    c76_l381_action_invoke(&mut instance);
}
