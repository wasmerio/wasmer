...
- **abort** ✅ 🔥 &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn abort(message: u32, vmctx: &mut Instance)
  ```
...
- **\_getenv** ✅ &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn _getenv(name: c_int, vmctx: &mut Instance)
  ```
- **\_putenv** ✅ &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn _putenv(name: c_int, vmctx: &mut Instance)
  ```
- **\_setenv** ✅ &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn _setenv(name: c_int, value: c_int, overwrite: c_int, vmctx: &mut Instance
  ```
- **\_unsetenv** ✅ &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn _unsetenv(name: c_int, vmctx: &mut Instance)
  ```
...
- **\_emscripten_memcpy_big** ✅ 🔥 &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn _emscripten_memcpy_big(dest: u32, src: u32, len: u32, vmctx: &mut Instance) -> u32
  ```
...
- **get_total_memory** ✅ &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn get_total_memory(vmctx: &mut Instance) -> u32
  ```
...
- **open** (\_\_\_syscall5) ✅ ❗️ 🔥 &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn open(path: u32, flags: c_int, mode: c_int, vmctx: &mut Instance) -> c_int
  ```
...
- **read** (\_\_\_syscall3) ✅ ❗️ &nbsp;&nbsp;&nbsp;&nbsp;[:top:](#host-apis)
  ```rust
  fn read(fd: c_int, buf: u32, count: size_t, vmctx: &mut Instance) -> ssize_t
  ```
