...
/// exit
pub fn ___syscall1(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) {
...
/// read
pub fn ___syscall3(ctx: FunctionEnv<'_, EmEnv>, _which: i32, mut varargs: VarArgs) -> i32 {
    // -> ssize_t
...
/// write
pub fn ___syscall4(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
/// close
pub fn ___syscall6(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
// chdir
pub fn ___syscall12(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
pub fn ___syscall10(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall10");
    -1
}

pub fn ___syscall14(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall14");
    -1
}

pub fn ___syscall15(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall15");
    -1
}

// getpid
pub fn ___syscall20(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall20 (getpid)");
    unsafe { getpid() }
}

pub fn ___syscall21(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall21");
    -1
}

pub fn ___syscall25(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall25");
    -1
}

pub fn ___syscall29(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall29");
    -1
}

pub fn ___syscall32(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall32");
    -1
}

pub fn ___syscall33(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall33");
    -1
}

pub fn ___syscall36(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall36");
    -1
}

// rename
pub fn ___syscall38(mut ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> i32 {
    debug!("emscripten::___syscall38 (rename)");
    let old_path = varargs.get_str(&ctx);
    let new_path = varargs.get_str(&ctx);
    let real_old_path_owned = get_cstr_path(ctx.as_store_mut(), old_path as *const _);
...
// rmdir
pub fn ___syscall40(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
// pipe
pub fn ___syscall42(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
pub fn ___syscall51(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall51");
    -1
}

pub fn ___syscall52(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall52");
    -1
}

pub fn ___syscall53(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall53");
    -1
}

pub fn ___syscall60(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall60");
    -1
}

// dup2
pub fn ___syscall63(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
// getppid
pub fn ___syscall64(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall64 (getppid)");
    unsafe { getpid() }
}

pub fn ___syscall66(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall66");
    -1
}

pub fn ___syscall75(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall75");
    -1
}

pub fn ___syscall91(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall91 - stub");
    0
}

pub fn ___syscall96(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall96");
    -1
}

pub fn ___syscall97(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall97");
    -1
}

pub fn ___syscall110(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall110");
    -1
}

pub fn ___syscall121(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall121");
    -1
}

pub fn ___syscall125(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall125");
    -1
}

pub fn ___syscall133(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall133");
    -1
}

pub fn ___syscall144(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall144");
    -1
}

pub fn ___syscall147(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall147");
    -1
}

pub fn ___syscall150(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall150");
    -1
}

pub fn ___syscall151(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall151");
    -1
}

pub fn ___syscall152(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall152");
    -1
}

pub fn ___syscall153(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall153");
    -1
}

pub fn ___syscall163(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall163");
    -1
}

// getcwd
pub fn ___syscall183(mut ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> i32 {
    debug!("emscripten::___syscall183");
    let buf_offset: WasmPtr<libc::c_char> = varargs.get(&ctx);
    let _size: c_int = varargs.get(&ctx);
    let path = get_current_directory(ctx.as_store_mut());
...
// mmap2
pub fn ___syscall192(mut ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
    ...
    if fd == -1 {
        let ptr = env::call_memalign(ctx.as_store_mut(), 16384, len);
        if ptr == 0 {
            // ENOMEM
            return -12;
        }
...
/// lseek
pub fn ___syscall140(ctx: FunctionEnv<'_, EmEnv>, _which: i32, mut varargs: VarArgs) -> i32 {
    // -> c_int
...
pub fn ___syscall145(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> i32 {
    // -> ssize_t
...
// writev
#[allow(clippy::cast_ptr_alignment)]
pub fn ___syscall146(ctx: FunctionEnv<'_, EmEnv>, _which: i32, mut varargs: VarArgs) -> i32 {
    // -> ssize_t
...
pub fn ___syscall191(ctx: FunctionEnv<'_, EmEnv>, _which: i32, mut varargs: VarArgs) -> i32 {
...
pub fn ___syscall193(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall193");
    -1
}

// stat64
pub fn ___syscall195(mut ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall195 (stat64) {}", _which);
    let pathname_addr = varargs.get_str(&ctx);
    let buf: u32 = varargs.get(&ctx);

    let real_path_owned = get_cstr_path(ctx.as_store_mut(), pathname_addr as *const _);
    let real_path = if let Some(ref rp) = real_path_owned {
        rp.as_c_str().as_ptr()
    } else {
        pathname_addr
...
// fstat64
pub fn ___syscall197(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
pub fn ___syscall209(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall209");
    -1
}

pub fn ___syscall211(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall211");
    -1
}

pub fn ___syscall218(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall218");
    -1
}

pub fn ___syscall268(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall268");
    -1
}

pub fn ___syscall269(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall269");
    -1
}

pub fn ___syscall272(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall272");
    -1
}

pub fn ___syscall295(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall295");
    -1
}

pub fn ___syscall296(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall296");
    -1
}

pub fn ___syscall297(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall297");
    -1
}

pub fn ___syscall298(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall298");
    -1
}

pub fn ___syscall300(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall300");
    -1
}

pub fn ___syscall301(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall301");
    -1
}

pub fn ___syscall302(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall302");
    -1
}

pub fn ___syscall303(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall303");
    -1
}

pub fn ___syscall304(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall304");
    -1
}

pub fn ___syscall305(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall305");
    -1
}

pub fn ___syscall306(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall306");
    -1
}

pub fn ___syscall307(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall307");
    -1
}

pub fn ___syscall308(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall308");
    -1
}

// utimensat
pub fn ___syscall320(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall320 (utimensat), {}", _which);
    0
}

pub fn ___syscall331(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall331");
    -1
}

pub fn ___syscall333(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall333");
    -1
}

pub fn ___syscall334(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall334");
    -1
}

pub fn ___syscall337(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall337");
    -1
}

// prlimit64
pub fn ___syscall340(ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut varargs: VarArgs) -> c_int {
...
pub fn ___syscall345(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
