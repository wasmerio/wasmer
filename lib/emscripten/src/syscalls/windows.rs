...
/// link
pub fn ___syscall9(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall9 (link) {}", _which);
    unimplemented!("emscripten::___syscall9 (link) {}", _which);
}

/// ftruncate64
pub fn ___syscall194(_ctx: FunctionEnvMut<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
...
// mkdir
pub fn ___syscall39(ctx: FunctionEnvMut<'_, EmEnv>, which: c_int, mut varargs: VarArgs) -> c_int {
...
/// dup
pub fn ___syscall41(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall41 (dup) {}", _which);
    unimplemented!("emscripten::___syscall41 (dup) {}", _which);
}

/// getrusage
pub fn ___syscall77(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall77 (getrusage) {}", _which);
    unimplemented!("emscripten::___syscall77 (getrusage) {}", _which);
}

/// symlink
pub fn ___syscall83(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall83 (symlink) {}", _which);
    unimplemented!("emscripten::___syscall83 (symlink) {}", _which);
}

/// readlink
pub fn ___syscall85(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
...
/// lchown
pub fn ___syscall198(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
...
/// getgroups
pub fn ___syscall205(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall205 (getgroups) {}", _which);
    unimplemented!("emscripten::___syscall205 (getgroups) {}", _which);
}

/// madvise
pub fn ___syscall219(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
...
/// ioctl
pub fn ___syscall54(_ctx: FunctionEnvMut<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// fchmod
pub fn ___syscall94(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
...
/// fsync
pub fn ___syscall118(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
...
/// fdatasync
pub fn ___syscall148(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall148 (fdatasync) {}", _which);
    unimplemented!("emscripten::___syscall148 (fdatasync) {}", _which);
}

// setpgid
pub fn ___syscall57(_ctx: FunctionEnvMut<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// poll
pub fn ___syscall168(_ctx: FunctionEnvMut<'_, EmEnv>, _which: i32, _varargs: VarArgs) -> i32 {
    debug!("emscripten::___syscall168(poll) - stub");
    -1
}

/// lstat64
pub fn ___syscall196(_ctx: FunctionEnvMut<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
...
// getdents
pub fn ___syscall220(_ctx: FunctionEnvMut<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
...
/// fchown
pub fn ___syscall207(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall207 (fchown) {}", _which);
    unimplemented!("emscripten::___syscall207 (fchown) {}", _which)
}

/// fallocate
pub fn ___syscall324(_ctx: FunctionEnvMut<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
