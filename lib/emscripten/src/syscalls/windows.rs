...
/// open
pub fn ___syscall5(mut ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall5 (open) {}", which);
    #[cfg(not(feature = "debug"))]
    let _ = which;
    let pathname_addr = varargs.get_str(&ctx);
    let real_path_owned = get_cstr_path(ctx.as_store_mut(), pathname_addr);
    ...
    match path_str {
        "/dev/urandom" => {
            ...
            let urandom_file_offset = unsafe { copy_cstr_into_wasm(ctx.as_store_mut(), ptr) };
...
/// link
pub fn ___syscall9(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall9 (link) {}", _which);
    unimplemented!("emscripten::___syscall9 (link) {}", _which);
}

/// ftruncate64
pub fn ___syscall194(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall194 - stub");
    unimplemented!("emscripten::___syscall194 - stub")
}

// chown
pub fn ___syscall212(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// access
pub fn ___syscall33(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall33 (access) {}", _which);
    unimplemented!("emscripten::___syscall33 (access) {}", _which);
}

/// nice
pub fn ___syscall34(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall34 (nice) {}", _which);
    unimplemented!("emscripten::___syscall34 (nice) {}", _which);
}

// mkdir
pub fn ___syscall39(ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut varargs: VarArgs) -> c_int {
...
/// dup
pub fn ___syscall41(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall41 (dup) {}", _which);
    unimplemented!("emscripten::___syscall41 (dup) {}", _which);
}

/// getrusage
pub fn ___syscall77(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall77 (getrusage) {}", _which);
    unimplemented!("emscripten::___syscall77 (getrusage) {}", _which);
}

/// symlink
pub fn ___syscall83(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall83 (symlink) {}", _which);
    unimplemented!("emscripten::___syscall83 (symlink) {}", _which);
}

/// readlink
pub fn ___syscall85(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall85 (readlink) {}", _which);
    -1
}

/// getpgid
pub fn ___syscall132(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall132 (getpgid)");
    -1
}

/// lchown
pub fn ___syscall198(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
...
/// getgroups
pub fn ___syscall205(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall205 (getgroups) {}", _which);
    unimplemented!("emscripten::___syscall205 (getgroups) {}", _which);
}

/// madvise
pub fn ___syscall219(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall212 (chown) {}", _which);
    unimplemented!("emscripten::___syscall212 (chown) {}", _which);
}

/// dup3
pub fn ___syscall330(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> pid_t {
    debug!("emscripten::___syscall330 (dup3)");
    -1
}

/// ioctl
pub fn ___syscall54(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// fchmod
pub fn ___syscall94(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
...
pub fn ___syscall102(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// fsync
pub fn ___syscall118(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall118 (fsync) {}", _which);
    unimplemented!("emscripten::___syscall118 (fsync) {}", _which);
}

// pread
pub fn ___syscall180(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
// pwrite
pub fn ___syscall181(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// wait4
#[allow(clippy::cast_ptr_alignment)]
pub fn ___syscall114(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> pid_t {
...
// select
#[allow(clippy::cast_ptr_alignment)]
pub fn ___syscall142(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// fdatasync
pub fn ___syscall148(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall148 (fdatasync) {}", _which);
    unimplemented!("emscripten::___syscall148 (fdatasync) {}", _which);
}

// setpgid
pub fn ___syscall57(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
pub fn ___syscall122(_ctx: FunctionEnv<'_, EmEnv>, which: c_int, mut _varargs: VarArgs) -> c_int {
...
/// poll
pub fn ___syscall168(_ctx: FunctionEnv<'_, EmEnv>, _which: i32, _varargs: VarArgs) -> i32 {
    debug!("emscripten::___syscall168(poll) - stub");
    -1
}

/// lstat64
pub fn ___syscall196(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
...
// getdents
pub fn ___syscall220(_ctx: FunctionEnv<'_, EmEnv>, _one: i32, _two: i32) -> i32 {
    debug!("emscripten::___syscall220");
    -1
}

// fcntl64
pub fn ___syscall221(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, mut _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall221 (fcntl64) {}", _which);
    -1
}

/// fchown
pub fn ___syscall207(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
    debug!("emscripten::___syscall207 (fchown) {}", _which);
    unimplemented!("emscripten::___syscall207 (fchown) {}", _which)
}

/// fallocate
pub fn ___syscall324(_ctx: FunctionEnv<'_, EmEnv>, _which: c_int, _varargs: VarArgs) -> c_int {
