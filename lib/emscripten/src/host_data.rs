...
/// EmscriptenImports
pub struct EmscriptenImports {}

impl EmscriptenImports {
    /// Generates an Emscripten environment that can be imported by a
    /// webassembly instance.
    pub fn generate(data: &EmscriptenData) -> Imports {
        let mut imports = Imports::new();
        let mut keys = Vec::new();
        let functions = EmscriptenImports::get_functions();
        ...
        for key in keys {
            ...
            let mut namespace = NamespaceMap::new();
    ...
    pub fn get_functions() -> HashMap<String, NamespaceMap> {
