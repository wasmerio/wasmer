...
pub fn generate_emscripten_env(globals: &mut EmscriptenGlobals) -> ImportObject {
    ...
    //            "_emscripten_get_heap_size" => func!(crate::emscripten_target::_emscripten_get_heap_size),
    //            "_emscripten_resize_heap" => func!(crate::emscripten_target::_emscripten_resize_heap),
