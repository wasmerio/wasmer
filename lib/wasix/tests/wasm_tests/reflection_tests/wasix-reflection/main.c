...
int main() {
  ...
  code = wasix_reflect_signature((wasix_function_pointer_t)nothing_ptr, NULL, 0,
                                 NULL, 0, &result);
  ...
  code = wasix_reflect_signature((wasix_function_pointer_t)triple_add_ptr,
                                 params, 5, results, 5, &result);
  ...
  code = wasix_reflect_signature((wasix_function_pointer_t)triple_add_ptr, NULL,
                                 0, NULL, 0, &result);
