...
int main() {
  ...
  code = wasix_reflect_signature((wasix_function_pointer_t)static_add, params,
                                 5, results, 5, &result);
  ...
  code = wasix_reflect_signature((wasix_function_pointer_t)static_no_params,
  ...
  code = wasix_reflect_signature((wasix_function_pointer_t)static_double_func,
