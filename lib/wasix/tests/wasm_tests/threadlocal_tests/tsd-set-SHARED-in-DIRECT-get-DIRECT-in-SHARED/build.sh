...
# Build strategy: SET_DATA=SHARED in DIRECT, GET_DATA=DIRECT in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_SHARED -DGET_DATA_DIRECT -DSET_DATA_PROXY_DIRECT -DGET_DATA_PROXY_SHARED \
    -o main.o
$CC main.o -I$SRCDIR -DSET_DATA_PROXY_DIRECT -DSET_DATA_SHARED $SRCDIR/set-data-proxy.c $SRCDIR/get-data.c -L$PWD -lget-data-proxy -lset-data -o main
