...
# Build strategy: SET_DATA=DIRECT in DYNAMIC, GET_DATA=DYNAMIC in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DIRECT -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_DYNAMIC -DGET_DATA_PROXY_SHARED \
    -o main.o
$CC main.o -I$SRCDIR $SRCDIR/set-data.c -L$PWD -lget-data-proxy -o main
