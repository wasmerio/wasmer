...
# Build strategy: SET_DATA=DYNAMIC in DIRECT, GET_DATA=DYNAMIC in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DYNAMIC -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_DIRECT -DGET_DATA_PROXY_SHARED \
    -o main.o
$CC main.o -I$SRCDIR -DSET_DATA_PROXY_DIRECT -DSET_DATA_DYNAMIC $SRCDIR/set-data-proxy.c -L$PWD -lget-data-proxy -o main
