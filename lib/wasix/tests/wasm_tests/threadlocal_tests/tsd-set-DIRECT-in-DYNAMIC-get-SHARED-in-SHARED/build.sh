...
# Build strategy: SET_DATA=DIRECT in DYNAMIC, GET_DATA=SHARED in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DIRECT -DGET_DATA_SHARED -DSET_DATA_PROXY_DYNAMIC -DGET_DATA_PROXY_SHARED \
    -o main.o
