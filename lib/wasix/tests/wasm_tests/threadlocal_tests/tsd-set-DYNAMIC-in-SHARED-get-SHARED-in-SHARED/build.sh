...
# Build strategy: SET_DATA=DYNAMIC in SHARED, GET_DATA=SHARED in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DYNAMIC -DGET_DATA_SHARED -DSET_DATA_PROXY_SHARED -DGET_DATA_PROXY_SHARED \
    -o main.o
