...
void* run_test(void* data) {
  ...
  set_data_proxy_func_t set_data_proxy =
      (set_data_proxy_func_t)dlsym(handle_set_data_proxy, "set_data_proxy");
  ...
  get_data_proxy_func_t get_data_proxy =
      (get_data_proxy_func_t)dlsym(handle_get_data_proxy, "get_data_proxy");
