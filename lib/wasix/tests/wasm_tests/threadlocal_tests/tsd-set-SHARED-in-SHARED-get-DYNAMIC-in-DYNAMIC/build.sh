...
# Build strategy: SET_DATA=SHARED in SHARED, GET_DATA=DYNAMIC in DYNAMIC
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_SHARED -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_SHARED -DGET_DATA_PROXY_DYNAMIC \
    -o main.o
