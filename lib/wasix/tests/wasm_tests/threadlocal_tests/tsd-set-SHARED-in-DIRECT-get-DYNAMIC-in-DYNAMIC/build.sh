...
# Build strategy: SET_DATA=SHARED in DIRECT, GET_DATA=DYNAMIC in DYNAMIC
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_SHARED -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_DIRECT -DGET_DATA_PROXY_DYNAMIC \
    -o main.o
$CC main.o -I$SRCDIR -DSET_DATA_PROXY_DIRECT -DSET_DATA_SHARED $SRCDIR/set-data-proxy.c -L$PWD -lset-data -o main
