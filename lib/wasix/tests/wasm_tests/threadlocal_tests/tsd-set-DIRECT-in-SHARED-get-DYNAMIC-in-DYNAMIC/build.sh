...
# Build strategy: SET_DATA=DIRECT in SHARED, GET_DATA=DYNAMIC in DYNAMIC
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DIRECT -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_SHARED -DGET_DATA_PROXY_DYNAMIC \
    -o main.o
$CC main.o -I$SRCDIR $SRCDIR/set-data.c -L$PWD -lset-data-proxy -o main
