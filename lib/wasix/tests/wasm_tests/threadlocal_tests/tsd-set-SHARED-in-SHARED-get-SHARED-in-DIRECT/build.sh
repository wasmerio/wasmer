...
# Build strategy: SET_DATA=SHARED in SHARED, GET_DATA=SHARED in DIRECT
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_SHARED -DGET_DATA_SHARED -DSET_DATA_PROXY_SHARED -DGET_DATA_PROXY_DIRECT \
    -o main.o
