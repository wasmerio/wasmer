...
// Even though POSIX requires the name to start with a slash, Linux also allows
// names with no or multiple leading slashes. However, names with embedded
...
#define VALID_NAME_8 \
  "/embedded\0null"  // Equivalent to "/embedded" ... why am I even testing
                     // this?
// #define VALID_NAME_9 "."
// #define VALID_NAME_10 ".."
#define INVALID_NAME_1 ""
#define INVALID_NAME_2 "/embedded/slash"
#define INVALID_NAME_3                                                         \
  "/name-that-is-way-too-long-"                                                \
...
// // NULL pointer is also invalid but results in a segmentation fault instead
// of sem_open returning SEM_FAILED #define INVALID_NAME_99 NULL
...
int main(void) {
  ...
  // expect_invalid_name(INVALID_NAME_99); // This one causes a segmentation
  // fault instead
