...
# Build strategy: SET_DATA=SHARED in DYNAMIC, GET_DATA=DYNAMIC in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_SHARED -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_DYNAMIC -DGET_DATA_PROXY_SHARED \
    -o main.o
