...
# Build strategy: SET_DATA=DYNAMIC in SHARED, GET_DATA=DYNAMIC in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DYNAMIC -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_SHARED -DGET_DATA_PROXY_SHARED \
    -o main.o
$CC main.o -L$PWD -lset-data-proxy -lget-data-proxy -o main
