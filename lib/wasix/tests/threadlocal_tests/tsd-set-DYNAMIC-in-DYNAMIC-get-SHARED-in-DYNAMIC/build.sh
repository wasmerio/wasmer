...
# Build strategy: SET_DATA=DYNAMIC in DYNAMIC, GET_DATA=SHARED in DYNAMIC
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DYNAMIC -DGET_DATA_SHARED -DSET_DATA_PROXY_DYNAMIC -DGET_DATA_PROXY_DYNAMIC \
    -o main.o
$CC main.o -o main
