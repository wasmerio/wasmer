...
# Build strategy: SET_DATA=DIRECT in SHARED, GET_DATA=DIRECT in SHARED
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DIRECT -DGET_DATA_DIRECT -DSET_DATA_PROXY_SHARED -DGET_DATA_PROXY_SHARED \
    -o main.o
$CC main.o -I$SRCDIR $SRCDIR/set-data.c $SRCDIR/get-data.c -L$PWD -lset-data-proxy -lget-data-proxy -o main
