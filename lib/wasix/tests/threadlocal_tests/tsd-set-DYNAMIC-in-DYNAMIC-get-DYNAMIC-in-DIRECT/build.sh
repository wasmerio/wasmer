...
# Build strategy: SET_DATA=DYNAMIC in DYNAMIC, GET_DATA=DYNAMIC in DIRECT
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DYNAMIC -DGET_DATA_DYNAMIC -DSET_DATA_PROXY_DYNAMIC -DGET_DATA_PROXY_DIRECT \
    -o main.o
$CC main.o -I$SRCDIR -DGET_DATA_PROXY_DIRECT -DGET_DATA_DYNAMIC $SRCDIR/get-data-proxy.c -o main
