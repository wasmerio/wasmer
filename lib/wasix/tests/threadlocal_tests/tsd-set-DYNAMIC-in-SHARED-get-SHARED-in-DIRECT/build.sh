...
# Build strategy: SET_DATA=DYNAMIC in SHARED, GET_DATA=SHARED in DIRECT
...
$CC -I$SRCDIR -c -fPIC $SRCDIR/main.c \
    -DTHREAD_MAIN -DSET_DATA_DYNAMIC -DGET_DATA_SHARED -DSET_DATA_PROXY_SHARED -DGET_DATA_PROXY_DIRECT \
    -o main.o
$CC main.o -I$SRCDIR -DGET_DATA_PROXY_DIRECT -DGET_DATA_SHARED $SRCDIR/get-data-proxy.c -L$PWD -lset-data-proxy -lget-data -o main
