...
fn wasix_exports_32(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "stackswitching_delete" => Function::new_typed_with_env(&mut store, env, stackswitching_delete::<Memory32>),
        "stackswitching_new" => Function::new_typed_with_env(&mut store, env, stackswitching_new::<Memory32>),
        "stackswitching_switch" => Function::new_typed_with_env(&mut store, env, stackswitching_switch::<Memory32>),
...
fn wasix_exports_64(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "stackswitching_delete" => Function::new_typed_with_env(&mut store, env, stackswitching_delete::<Memory64>),
        "stackswitching_new" => Function::new_typed_with_env(&mut store, env, stackswitching_new::<Memory64>),
        "stackswitching_switch" => Function::new_typed_with_env(&mut store, env, stackswitching_switch::<Memory64>),
