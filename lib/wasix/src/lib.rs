...
fn wasix_exports_32(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "continuation_context" => Function::new_typed_with_env(&mut store, env, continuation_context::<Memory32>),
        "continuation_delete" => Function::new_typed_with_env(&mut store, env, continuation_delete::<Memory32>),
        "continuation_new" => Function::new_typed_with_env(&mut store, env, continuation_new::<Memory32>),
        "continuation_switch" => Function::new_typed_with_env(&mut store, env, continuation_switch::<Memory32>),
...
fn wasix_exports_64(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "continuation_context" => Function::new_typed_with_env(&mut store, env, continuation_context::<Memory64>),
        "continuation_delete" => Function::new_typed_with_env(&mut store, env, continuation_delete::<Memory64>),
        "continuation_new" => Function::new_typed_with_env(&mut store, env, continuation_new::<Memory64>),
        "continuation_switch" => Function::new_typed_with_env(&mut store, env, continuation_switch::<Memory64>),
