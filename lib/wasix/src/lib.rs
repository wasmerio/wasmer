...
fn wasix_exports_32(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "coroutine_context" => Function::new_typed_with_env(&mut store, env, coroutine_context::<Memory32>),
        "coroutine_delete" => Function::new_typed_with_env(&mut store, env, coroutine_delete::<Memory32>),
        "coroutine_new" => Function::new_typed_with_env(&mut store, env, coroutine_new::<Memory32>),
        "coroutine_switch" => Function::new_typed_with_env(&mut store, env, coroutine_switch::<Memory32>),
...
fn wasix_exports_64(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "coroutine_context" => Function::new_typed_with_env(&mut store, env, coroutine_context::<Memory64>),
        "coroutine_delete" => Function::new_typed_with_env(&mut store, env, coroutine_delete::<Memory64>),
        "coroutine_new" => Function::new_typed_with_env(&mut store, env, coroutine_new::<Memory64>),
        "coroutine_switch" => Function::new_typed_with_env(&mut store, env, coroutine_switch::<Memory64>),
