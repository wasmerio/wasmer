...
fn wasix_exports_32(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "sock_recv_msg" => Function::new_typed_with_env(&mut store, env, sock_recv_msg::<Memory32>),
        "sock_send" => Function::new_typed_with_env(&mut store, env, sock_send::<Memory32>),
        "sock_send_msg" => Function::new_typed_with_env(&mut store, env, sock_send_msg::<Memory32>),
...
fn wasix_exports_64(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "sock_recv_msg" => Function::new_typed_with_env(&mut store, env, sock_recv_msg::<Memory64>),
        "sock_send" => Function::new_typed_with_env(&mut store, env, sock_send::<Memory64>),
        "sock_send_msg" => Function::new_typed_with_env(&mut store, env, sock_send_msg::<Memory64>),
