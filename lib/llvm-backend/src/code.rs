...
impl<'ctx> FunctionCodeGenerator<CodegenError> for LLVMFunctionCodeGenerator<'ctx> {
    ...
    fn feed_event(
        ...
        match *op {
             ...
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#control-flow-instructions
             ***************************/
            Operator::Block { ty } => {
            ...
            /***************************
             * Basic instructions.
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#basic-instructions
             ***************************/
            Operator::Nop => {
                // Do nothing.
            }
             ...
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#integer-arithmetic-instructions
             ***************************/
             ...
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#floating-point-arithmetic-instructions
             ***************************/
            Operator::F32Add => {
                let ((v1, i1), (v2, i2)) = state.pop2_extra()?;
             ...
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#integer-comparison-instructions
             ***************************/
             ...
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#floating-point-comparison-instructions
             ***************************/
             ...
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#conversion-instructions
             ***************************/
            Operator::I32WrapI64 => {
                let (v, i) = state.pop1_extra()?;
                let v = apply_pending_canonicalization(builder, intrinsics, v, i);
             ...
             * https://github.com/WebAssembly/sign-extension-ops/blob/main/proposals/sign-extension-ops/Overview.md
             ***************************/
             ...
             * https://github.com/sunfishcode/wasm-reference-manual/blob/main/WebAssembly.md#load-and-store-instructions
             ***************************/
