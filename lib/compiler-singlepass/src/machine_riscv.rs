...
impl Machine for MachineRiscv {
    ...
    fn gen_std_trampoline(
        ...
        gen_std_trampoline_riscv(sig, calling_convention, output_budget)
    }
    ...
    fn gen_std_dynamic_import_trampoline(
        ...
        gen_std_dynamic_import_trampoline_riscv(vmoffsets, sig, output_budget)
    }
    ...
    fn gen_import_call_trampoline(
        ...
        gen_import_call_trampoline_riscv(vmoffsets, index, sig, calling_convention, output_budget)
    }
