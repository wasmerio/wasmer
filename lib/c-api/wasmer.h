...
typedef union wasmer_import_export_value {
  const struct wasmer_import_func_t *func;
  const struct wasmer_table_t *table;
  const struct wasmer_memory_t *memory;
  const struct wasmer_global_t *global;
} wasmer_import_export_value;

typedef struct wasmer_import_t {
  struct wasmer_byte_array module_name;
  struct wasmer_byte_array import_name;
  wasmer_import_export_kind tag;
  union wasmer_import_export_value value;
} wasmer_import_t;
...
typedef struct wasmer_limits_t {
   ...
   */
  struct wasmer_limit_option_t max;
} wasmer_limits_t;
 ...
 */
enum wasmer_result_t wasmer_compile(struct wasmer_module_t **module,
                                    uint8_t *wasm_bytes,
 ...
 * bad things.
 */
enum wasmer_result_t wasmer_emscripten_call_main(struct wasmer_instance_t *instance,
                                                 const struct wasmer_byte_array *args,
 ...
 */
void wasmer_emscripten_destroy_globals(struct wasmer_emscripten_globals_t *globals);
#endif
 ...
 */
struct wasmer_import_object_t *wasmer_emscripten_generate_import_object(struct wasmer_emscripten_globals_t *globals);
#endif
 ...
 */
struct wasmer_emscripten_globals_t *wasmer_emscripten_get_globals(const struct wasmer_module_t *module);
#endif
 ...
 */
enum wasmer_result_t wasmer_emscripten_set_up(struct wasmer_instance_t *instance,
                                              struct wasmer_emscripten_globals_t *globals);
#endif

/**
 * Gets export descriptor kind
 */
wasmer_import_export_kind wasmer_export_descriptor_kind(struct wasmer_export_descriptor_t *export_);

/**
 * Gets name for the export descriptor
 */
struct wasmer_byte_array wasmer_export_descriptor_name(struct wasmer_export_descriptor_t *export_descriptor);
 ...
 */
void wasmer_export_descriptors(const struct wasmer_module_t *module,
                               struct wasmer_export_descriptors_t **export_descriptors);

/**
 * Frees the memory for the given export descriptors
 */
void wasmer_export_descriptors_destroy(struct wasmer_export_descriptors_t *export_descriptors);

/**
 * Gets export descriptor by index
 */
struct wasmer_export_descriptor_t *wasmer_export_descriptors_get(struct wasmer_export_descriptors_t *export_descriptors,
                                                                 int idx);

/**
 * Gets the length of the export descriptors
 */
int wasmer_export_descriptors_len(struct wasmer_export_descriptors_t *exports);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_export_func_call(const struct wasmer_export_func_t *func,
                                             const struct wasmer_value_t *params,
                                             unsigned int params_len,
                                             struct wasmer_value_t *results,
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_export_func_params(const struct wasmer_export_func_t *func,
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_export_func_params_arity(const struct wasmer_export_func_t *func,
                                                     uint32_t *result);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_export_func_returns(const struct wasmer_export_func_t *func,
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_export_func_returns_arity(const struct wasmer_export_func_t *func,
                                                      uint32_t *result);

/**
 * Gets wasmer_export kind
 */
wasmer_import_export_kind wasmer_export_kind(struct wasmer_export_t *export_);

/**
 * Gets name from wasmer_export
 */
struct wasmer_byte_array wasmer_export_name(struct wasmer_export_t *export_);

/**
 * Gets export func from export
 */
const struct wasmer_export_func_t *wasmer_export_to_func(const struct wasmer_export_t *export_);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_export_to_memory(const struct wasmer_export_t *export_,
                                             struct wasmer_memory_t **memory);
 ...
 * ```
 */
void wasmer_exports_destroy(struct wasmer_exports_t *exports);

/**
 * Gets wasmer_export by index
 */
struct wasmer_export_t *wasmer_exports_get(struct wasmer_exports_t *exports, int idx);

/**
 * Gets the length of the exports
 */
int wasmer_exports_len(struct wasmer_exports_t *exports);

/**
 * Frees memory for the given Global
 */
void wasmer_global_destroy(struct wasmer_global_t *global);

/**
 * Gets the value stored by the given Global
 */
struct wasmer_value_t wasmer_global_get(struct wasmer_global_t *global);

/**
 * Returns a descriptor (type, mutability) of the given Global
 */
struct wasmer_global_descriptor_t wasmer_global_get_descriptor(struct wasmer_global_t *global);
 ...
 */
struct wasmer_global_t *wasmer_global_new(struct wasmer_value_t value, bool mutable_);

/**
 * Sets the value stored by the given Global
 */
void wasmer_global_set(struct wasmer_global_t *global, struct wasmer_value_t value);

/**
 * Gets export descriptor kind
 */
wasmer_import_export_kind wasmer_import_descriptor_kind(struct wasmer_import_descriptor_t *export_);

/**
 * Gets module name for the import descriptor
 */
struct wasmer_byte_array wasmer_import_descriptor_module_name(struct wasmer_import_descriptor_t *import_descriptor);

/**
 * Gets name for the import descriptor
 */
struct wasmer_byte_array wasmer_import_descriptor_name(struct wasmer_import_descriptor_t *import_descriptor);
 ...
 */
void wasmer_import_descriptors(const struct wasmer_module_t *module,
                               struct wasmer_import_descriptors_t **import_descriptors);

/**
 * Frees the memory for the given import descriptors
 */
void wasmer_import_descriptors_destroy(struct wasmer_import_descriptors_t *import_descriptors);

/**
 * Gets import descriptor by index
 */
struct wasmer_import_descriptor_t *wasmer_import_descriptors_get(struct wasmer_import_descriptors_t *import_descriptors,
                                                                 unsigned int idx);

/**
 * Gets the length of the import descriptors
 */
unsigned int wasmer_import_descriptors_len(struct wasmer_import_descriptors_t *exports);

/**
 * Frees memory for the given Func
 */
void wasmer_import_func_destroy(struct wasmer_import_func_t *func);
 ...
 */
struct wasmer_import_func_t *wasmer_import_func_new(void (*func)(void *data),
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_import_func_params(const struct wasmer_import_func_t *func,
                                               wasmer_value_tag *params,
                                               unsigned int params_len);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_import_func_params_arity(const struct wasmer_import_func_t *func,
                                                     uint32_t *result);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_import_func_returns(const struct wasmer_import_func_t *func,
                                                wasmer_value_tag *returns,
                                                unsigned int returns_len);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_import_func_returns_arity(const struct wasmer_import_func_t *func,
                                                      uint32_t *result);

/**
 * Frees memory of the given ImportObject
 */
void wasmer_import_object_destroy(struct wasmer_import_object_t *import_object);

/**
 * Extends an existing import object with new imports
 */
enum wasmer_result_t wasmer_import_object_extend(struct wasmer_import_object_t *import_object,
                                                 const struct wasmer_import_t *imports,
 ...
 */
enum wasmer_result_t wasmer_import_object_get_import(const struct wasmer_import_object_t *import_object,
                                                     struct wasmer_byte_array namespace_,
                                                     struct wasmer_byte_array name,
                                                     struct wasmer_import_t *import,
                                                     union wasmer_import_export_value *import_export_value,
                                                     uint32_t tag);
 ...
 */
void wasmer_import_object_imports_destroy(struct wasmer_import_t *imports, uint32_t imports_len);

/**
 * Returns true if further calls to `wasmer_import_object_iter_next` will
 * not return any new data
 */
bool wasmer_import_object_iter_at_end(struct wasmer_import_object_iter_t *import_object_iter);

/**
 * Frees the memory allocated by `wasmer_import_object_iterate_functions`
 */
void wasmer_import_object_iter_destroy(struct wasmer_import_object_iter_t *import_object_iter);
 ...
 */
enum wasmer_result_t wasmer_import_object_iter_next(struct wasmer_import_object_iter_t *import_object_iter,
                                                    struct wasmer_import_t *import);
 ...
 */
struct wasmer_import_object_iter_t *wasmer_import_object_iterate_functions(const struct wasmer_import_object_t *import_object);

/**
 * Creates a new empty import object.
 * See also `wasmer_import_object_append`
 */
struct wasmer_import_object_t *wasmer_import_object_new(void);
 ...
 * ```
 */
enum wasmer_result_t wasmer_instance_call(struct wasmer_instance_t *instance,
                                          const char *name,
                                          const struct wasmer_value_t *params,
                                          uint32_t params_len,
                                          struct wasmer_value_t *results,
 ...
 */
void *wasmer_instance_context_data_get(const struct wasmer_instance_context_t *ctx);
 ...
 * ```
 */
void wasmer_instance_context_data_set(struct wasmer_instance_t *instance,
                                      void *data_ptr);
 ...
 */
const struct wasmer_instance_context_t *wasmer_instance_context_get(struct wasmer_instance_t *instance);
 ...
 * ```
 */
const struct wasmer_memory_t *wasmer_instance_context_memory(const struct wasmer_instance_context_t *ctx,
 ...
 * ```
 */
void wasmer_instance_exports(struct wasmer_instance_t *instance, struct wasmer_exports_t **exports);
 ...
 * ```
 */
enum wasmer_result_t wasmer_instantiate(struct wasmer_instance_t **instance,
                                        uint8_t *wasm_bytes,
                                        uint32_t wasm_bytes_len,
                                        struct wasmer_import_t *imports,
                                        int imports_len);
 ...
 * ```
 */
uint8_t *wasmer_memory_data(const struct wasmer_memory_t *memory);
 ...
 * ```
 */
uint32_t wasmer_memory_data_length(const struct wasmer_memory_t *memory);
 ...
 * ```
 */
void wasmer_memory_destroy(struct wasmer_memory_t *memory);
 ...
 * ```
 */
enum wasmer_result_t wasmer_memory_grow(struct wasmer_memory_t *memory, uint32_t delta);
 ...
 * ```
 */
uint32_t wasmer_memory_length(const struct wasmer_memory_t *memory);
 ...
 * ```
 */
enum wasmer_result_t wasmer_memory_new(struct wasmer_memory_t **memory,
                                       struct wasmer_limits_t limits);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_module_deserialize(struct wasmer_module_t **module,
                                               const struct wasmer_serialized_module_t *serialized_module);

/**
 * Frees memory for the given Module
 */
void wasmer_module_destroy(struct wasmer_module_t *module);
 ...
 */
enum wasmer_result_t wasmer_module_import_instantiate(struct wasmer_instance_t **instance,
                                                      const struct wasmer_module_t *module,
                                                      const struct wasmer_import_object_t *import_object);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_module_instantiate(const struct wasmer_module_t *module,
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_module_serialize(struct wasmer_serialized_module_t **serialized_module_out,
                                             const struct wasmer_module_t *module);

/**
 * Get bytes of the serialized module.
 */
struct wasmer_byte_array wasmer_serialized_module_bytes(const struct wasmer_serialized_module_t *serialized_module);

/**
 * Frees memory for the given serialized Module.
 */
void wasmer_serialized_module_destroy(struct wasmer_serialized_module_t *serialized_module);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_serialized_module_from_bytes(struct wasmer_serialized_module_t **serialized_module,
 ...
 */
void wasmer_table_destroy(struct wasmer_table_t *table);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_table_grow(struct wasmer_table_t *table, uint32_t delta);

/**
 * Returns the current length of the given Table
 */
uint32_t wasmer_table_length(struct wasmer_table_t *table);
 ...
 * and `wasmer_last_error_message` to get an error message.
 */
enum wasmer_result_t wasmer_table_new(struct wasmer_table_t **table, struct wasmer_limits_t limits);
 ...
 */
enum wasmer_result_t wasmer_trap(const struct wasmer_instance_context_t *_ctx,
 ...
 * empty values.
 */
struct wasmer_import_object_t *wasmer_wasi_generate_default_import_object(void);
#endif
 ...
 */
struct wasmer_import_object_t *wasmer_wasi_generate_import_object(const struct wasmer_byte_array *args,
                                                                  unsigned int args_len,
                                                                  const struct wasmer_byte_array *envs,
                                                                  unsigned int envs_len,
                                                                  const struct wasmer_byte_array *preopened_files,
                                                                  unsigned int preopened_files_len,
                                                                  const struct wasmer_wasi_map_dir_entry_t *mapped_dirs,
 ...
 */
struct wasmer_import_object_t *wasmer_wasi_generate_import_object_for_version(unsigned char version,
                                                                              const struct wasmer_byte_array *args,
                                                                              unsigned int args_len,
                                                                              const struct wasmer_byte_array *envs,
                                                                              unsigned int envs_len,
 ...
 */
Version wasmer_wasi_get_version(const struct wasmer_module_t *module);
#endif
