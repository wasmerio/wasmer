...
use crate::{
    ...
    state::{
        ...
        virtual_file_type_to_wasi_file_type, Fd, Inode, InodeVal, Kind, PollEvent, PollEventSet,
...
pub fn poll_oneoff(
    ...
    poll_oneoff_impl(env, in_, out_, nsubscriptions, nevents)
}
...
{
    crate::state::poll(files, events, seen_events)
}
