...
//        let type_size = get_encoding_size(ttype_encoding);
//        let mut action_record = unsafe { action_table.offset(cs_action_entry as isize - 1) };
//        let mut next_action_off = 0;
//
//        loop {
//            let mut action_reader = DwarfReader::new(action_record);
//            let ttype_index = unsafe { action_reader.read_sleb128() };
//
//            let mut ttype_ptr = class_info.wrapping_sub((ttype_index * (type_size as i64)) as _);
//
//            let value_ptr = unsafe {
//                read_encoded_pointer(&mut DwarfReader::new(ttype_ptr), context, ttype_encoding)
//                    .unwrap()
//            };
//
//            unsafe {
//                eprintln!(
//                    "ttype_index: {ttype_index}, action_off: {next_action_off},  type_ptr: {ttype_ptr:p}, cont: {}, val-ptr: {value_ptr:p}",
//                    **std::mem::transmute::<*const u8, *const *const i32>(ttype_ptr),
//                );
//            }
//
//            next_action_off = unsafe { action_reader.read_sleb128() };
//
//            if next_action_off == 0 {
//                return EHAction::None;
//            }
//
//            unsafe {
//                action_record = action_record.offset(next_action_off as isize);
//            }
//        }
//    }
//}
