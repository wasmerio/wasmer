...
pub mod wasi_filesystem {
    ...
    impl core::fmt::Debug for Type {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            match self {
                Type::Unknown => f.debug_tuple("Type::Unknown").finish(),
                Type::BlockDevice => f.debug_tuple("Type::BlockDevice").finish(),
                Type::CharacterDevice => f.debug_tuple("Type::CharacterDevice").finish(),
                Type::Directory => f.debug_tuple("Type::Directory").finish(),
                Type::Fifo => f.debug_tuple("Type::Fifo").finish(),
                Type::SymbolicLink => f.debug_tuple("Type::SymbolicLink").finish(),
                Type::RegularFile => f.debug_tuple("Type::RegularFile").finish(),
                Type::Socket => f.debug_tuple("Type::Socket").finish(),
            }
        }
    }
    ...
    impl WasiFilesystem {
        ...
        fn add_to_imports(
            ...
            canonical_abi.insert(
                ...
                wasmer::Function::new_typed_with_env(
                    &mut store,
                    &env,
                    move |mut store: wasmer::FunctionEnvMut<WasiFilesystemData>,
                          idx: u32|
        ...
        pub fn instantiate(
            ...
            let instance = wasmer::Instance::new(&mut store, module, &*imports)?;
            {
                let dtor0 = instance
                    .exports
                    .get_typed_function(&store, "canonical_abi_drop_descriptor")?
                    .clone();
        ...
        pub fn new(
            ...
            let func_descriptor_fadvise = _instance
                .exports
                .get_typed_function(&store, "descriptor::fadvise")?;
        ...
        pub fn descriptor_fadvise(
            ...
            len: u64,
            advice: Advice,
        ) -> Result<Result<(), Errno>, wasmer::RuntimeError> {
            ...
            let result1 = self.func_descriptor_fadvise.call(
                store,
                handle0 as i32,
                wit_bindgen_wasmer::rt::as_i64(offset),
                wit_bindgen_wasmer::rt::as_i64(len),
                advice as i32,
            )?;
