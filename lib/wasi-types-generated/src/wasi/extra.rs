...
pub fn expose_types_dummy_func(
    fd: Fd,
    dirent: Dirent,
    snapshot0_dirent: Snapshot0Dirent,
    snapshot0_event: Snapshot0Event,
    event_enum: EventEnum,
    event: Event,
    fdstat: Fdstat,
    subscription_clock: SubscriptionClock,
    snapshot0_subscription_clock: Snapshot0SubscriptionClock,
    subscription: Subscription,
    snapshot0_subscription: Snapshot0Subscription,
    device: Device,
    linkcount: Linkcount,
    snapshot0_linkcount: Snapshot0Linkcount,
    filestat: Filestat,
    snapshot0_filestat: Snapshot0Filestat,
    tty: Tty,
    tid: Tid,
    pid: Pid,
    bus_data_format: BusDataFormat,
    bid: Bid,
    option_bid: OptionBid,
    cid: Cid,
    option_cid: OptionCid,
    option_fd: OptionFd,
    bus_handles: BusHandles,
    exit_code: ExitCode,
    bus_event_exit: BusEventExit,
    bus_event_fault: BusEventFault,
    bus_event_close: BusEventClose,
    prestat_u_dir: PrestatUDir,
    prestat_u: PrestatU,
    event_fd_flags: EventFdFlags,
    prestat: Prestat,
    ...
    unsafe {
        ...
        *((ptr0 + 120) as *mut u8) = (match error10 {
        ...
        let Fdstat {
            fs_filetype: fs_filetype15,
            fs_flags: fs_flags15,
            fs_rights_base: fs_rights_base15,
            fs_rights_inheriting: fs_rights_inheriting15,
        } = fdstat;
        ...
        match data23 {
            ...
            SubscriptionEnum::Read(e) => {
                *((ptr0 + 256) as *mut u8) = (1i32) as u8;
                let SubscriptionFsReadwrite {
                    file_descriptor: file_descriptor26,
                } = e;
            ...
            SubscriptionEnum::Write(e) => {
                *((ptr0 + 256) as *mut u8) = (2i32) as u8;
                let SubscriptionFsReadwrite {
                    file_descriptor: file_descriptor27,
                } = e;
        ...
        match data28 {
            ...
            Snapshot0SubscriptionEnum::Read(e) => {
                *((ptr0 + 304) as *mut u8) = (1i32) as u8;
                let SubscriptionFsReadwrite {
                    file_descriptor: file_descriptor31,
                } = e;
            ...
            Snapshot0SubscriptionEnum::Write(e) => {
                *((ptr0 + 304) as *mut u8) = (2i32) as u8;
                let SubscriptionFsReadwrite {
                    file_descriptor: file_descriptor32,
                } = e;
        ...
        *((ptr0 + 432) as *mut i64) = wit_bindgen_rust::rt::as_i64(st_ctim33);
        let Snapshot0Filestat {
            st_dev: st_dev34,
            st_ino: st_ino34,
            st_filetype: st_filetype34,
            st_nlink: st_nlink34,
            st_size: st_size34,
            st_atim: st_atim34,
            st_mtim: st_mtim34,
        ...
        *((ptr0 + 488) as *mut i64) = wit_bindgen_rust::rt::as_i64(st_ctim34);
        let Tty {
            ...
            width: width35,
            height: height35,
            stdin_tty: stdin_tty35,
            stdout_tty: stdout_tty35,
            stderr_tty: stderr_tty35,
            echo: echo35,
            line_buffered: line_buffered35,
        } = tty;
        ...
        *((ptr0 + 512) as *mut u8) = (match stdin_tty35 {
            true => 1,
            false => 0,
        }) as u8;
        *((ptr0 + 513) as *mut u8) = (match stdout_tty35 {
            true => 1,
            false => 0,
        }) as u8;
        *((ptr0 + 514) as *mut u8) = (match stderr_tty35 {
            true => 1,
            false => 0,
        }) as u8;
        *((ptr0 + 515) as *mut u8) = (match echo35 {
            true => 1,
            false => 0,
        }) as u8;
        *((ptr0 + 516) as *mut u8) = (match line_buffered35 {
            true => 1,
            false => 0,
        }) as u8;
        ...
        *((ptr0 + 744) as *mut u8) = (match timeout {
        ...
        extern "C" {
            ...
            #[cfg_attr(
                ...
                link_name = "output_expose-types-dummy-func"
            )]
            fn wit_import(_: i32);
        }
        wit_import(ptr0);
