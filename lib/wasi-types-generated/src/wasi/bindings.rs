    ...
    pub fn expose_types_dummy_func(
        ...
        unsafe {
            ...
            *((ptr0 + 64) as *mut u8) = (match error6 {
            ...
            let Fdstat {
                fs_filetype: fs_filetype11,
                fs_flags: fs_flags11,
                fs_rights_base: fs_rights_base11,
                fs_rights_inheriting: fs_rights_inheriting11,
            } = fdstat;
            ...
            match data19 {
                ...
                SubscriptionEnum::Read(e) => {
                    *((ptr0 + 200) as *mut u8) = (1i32) as u8;
                    let SubscriptionFsReadwrite {
                        file_descriptor: file_descriptor22,
                    } = e;
                ...
                SubscriptionEnum::Write(e) => {
                    *((ptr0 + 200) as *mut u8) = (2i32) as u8;
                    let SubscriptionFsReadwrite {
                        file_descriptor: file_descriptor23,
                    } = e;
            ...
            match data24 {
                ...
                Snapshot0SubscriptionEnum::Write(e) => {
                    *((ptr0 + 248) as *mut u8) = (2i32) as u8;
                    let SubscriptionFsReadwrite {
                        file_descriptor: file_descriptor28,
                    } = e;
            ...
            *((ptr0 + 432) as *mut i64) = wit_bindgen_rust::rt::as_i64(st_ctim30);
            let Tty {
                ...
                width: width31,
                height: height31,
                stdin_tty: stdin_tty31,
                stdout_tty: stdout_tty31,
                stderr_tty: stderr_tty31,
                echo: echo31,
                line_buffered: line_buffered31,
            } = tty;
            ...
            *((ptr0 + 456) as *mut u8) = (match stdin_tty31 {
                true => 1,
                false => 0,
            }) as u8;
            *((ptr0 + 457) as *mut u8) = (match stdout_tty31 {
                true => 1,
                false => 0,
            }) as u8;
            *((ptr0 + 458) as *mut u8) = (match stderr_tty31 {
                true => 1,
                false => 0,
            }) as u8;
            *((ptr0 + 459) as *mut u8) = (match echo31 {
                true => 1,
                false => 0,
            }) as u8;
            *((ptr0 + 460) as *mut u8) = (match line_buffered31 {
                true => 1,
                false => 0,
            }) as u8;
            *((ptr0 + 464) as *mut i32) = wit_bindgen_rust::rt::as_i32(tid);
            *((ptr0 + 468) as *mut i32) = wit_bindgen_rust::rt::as_i32(pid);
            *((ptr0 + 472) as *mut u8) = (match bus_data_format {
                BusDataFormat::Raw => 0,
