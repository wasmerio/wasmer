...
pub mod wasi {
  ...
  wit_bindgen_wasmer::bitflags::bitflags! {
    /// File descriptor rights, determining which actions may be performed, snapshot0 version.
    pub struct Snapshot0Rights: u64 {/// The right to invoke `fd_datasync`.
      /// 
  ...
  impl core::fmt::Display for Snapshot0Rights{
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      f.write_str("Snapshot0Rights(")?;
  ...
  impl core::fmt::Debug for Snapshot0Filetype {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      match self {
        Snapshot0Filetype::Unknown => {
          f.debug_tuple("Snapshot0Filetype::Unknown").finish()
        }
        Snapshot0Filetype::BlockDevice => {
          f.debug_tuple("Snapshot0Filetype::BlockDevice").finish()
        }
        Snapshot0Filetype::CharacterDevice => {
          f.debug_tuple("Snapshot0Filetype::CharacterDevice").finish()
        }
        Snapshot0Filetype::Directory => {
          f.debug_tuple("Snapshot0Filetype::Directory").finish()
        }
        Snapshot0Filetype::RegularFile => {
          f.debug_tuple("Snapshot0Filetype::RegularFile").finish()
        }
        Snapshot0Filetype::SocketDgram => {
          f.debug_tuple("Snapshot0Filetype::SocketDgram").finish()
        }
        Snapshot0Filetype::SocketStream => {
          f.debug_tuple("Snapshot0Filetype::SocketStream").finish()
        }
        Snapshot0Filetype::SymbolicLink => {
          f.debug_tuple("Snapshot0Filetype::SymbolicLink").finish()
        }
      }
    }
  }
  ...
  impl Wasi {
    ...
    /// Dummy function to expose type into generated code
    pub fn dirent_dummy_func(&self, store: &mut wasmer::Store,dummy: Dirent,)-> Result<(), wasmer::RuntimeError> {
      let Dirent{ d_next:d_next0, d_ino:d_ino0, d_type:d_type0, d_namlen:d_namlen0, } = dummy;
      self.func_dirent_dummy_func.call(store, wit_bindgen_wasmer::rt::as_i64(d_next0), wit_bindgen_wasmer::rt::as_i64(d_ino0), d_type0 as i32, wit_bindgen_wasmer::rt::as_i32(d_namlen0), )?;
      Ok(())
    }
    /// Dummy function to expose type into generated code
