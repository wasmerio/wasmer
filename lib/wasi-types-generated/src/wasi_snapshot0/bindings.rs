...
pub mod wasi_snapshot0 {
  ...
  impl core::fmt::Debug for SubscriptionClock {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      f.debug_struct("SubscriptionClock").field("identifier", &self.identifier).field("id", &self.id).field("timeout", &self.timeout).field("precision", &self.precision).field("flags", &self.flags).finish()}
  }
  ...
  pub struct WasiSnapshot0 {
    ...
    func_subscription_clock_dummy_func: wasmer::TypedFunction<(i64,i32,i64,i64,i32,), ()>,
  }
  impl WasiSnapshot0 {
    ...
    pub fn dirent_dummy_func(&self, store: &mut wasmer::Store,dummy: Dirent,)-> Result<(), wasmer::RuntimeError> {
      let Dirent{ d_next:d_next0, d_ino:d_ino0, d_namlen:d_namlen0, d_type:d_type0, } = dummy;
    ...
    pub fn subscription_clock_dummy_func(&self, store: &mut wasmer::Store,dummy: SubscriptionClock,)-> Result<(), wasmer::RuntimeError> {
      let SubscriptionClock{ identifier:identifier0, id:id0, timeout:timeout0, precision:precision0, flags:flags0, } = dummy;
      let flags1 = flags0;
      self.func_subscription_clock_dummy_func.call(store, wit_bindgen_wasmer::rt::as_i64(identifier0), id0 as i32, wit_bindgen_wasmer::rt::as_i64(timeout0), wit_bindgen_wasmer::rt::as_i64(precision0), (flags1.bits >> 0) as i32, )?;
      Ok(())
    }
  }
  #[allow(unused_imports)]
