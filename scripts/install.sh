...
#  1) https://raw.githubusercontent.com/golang/dep/main/install.sh
#  2) https://sh.rustup.rs
#  3) https://yarnpkg.com/install.sh
#  4) https://raw.githubusercontent.com/brainsik/virtualenv-burrito/main/virtualenv-burrito.sh
#
...
# $ curl https://raw.githubusercontent.com/wasmerio/wasmer/main/install.sh | sh
